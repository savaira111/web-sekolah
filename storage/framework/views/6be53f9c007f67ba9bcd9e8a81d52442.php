<?php $__env->startSection('title', 'Rohis - SMKS Mahaputra'); ?>
...
<section class="relative h-[540px] flex items-center overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img src="<?php echo e(asset('images/extracurriculars/thumbs/rohis.png')); ?>" alt="Hero" class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-[#0F172A]/80 backdrop-blur-sm"></div>
    </div>

    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div class="space-y-6 max-w-4xl">
            <span class="inline-block px-4 py-1.5 bg-blue-600 text-white text-[10px] font-bold rounded-lg uppercase tracking-wider">Umum</span>
            
            <div class="flex items-center gap-6">
                <a href="<?php echo e(route('extracurriculars.index')); ?>" class="inline-flex items-center justify-center w-12 h-12 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-full hover:bg-white/30 transition-all shadow-lg shrink-0" title="Kembali">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M15 19l-7-7 7-7"></path></svg>
                </a>
                <h1 class="text-4xl lg:text-6xl font-black text-white leading-tight">
                    Kerohanian <span class="text-blue-500">Islam (Rohis)</span>
                </h1>
            </div>
            <p class="text-lg text-gray-300 max-w-2xl leading-relaxed font-medium">
                Mengembangkan karakter spiritual dan wawasan keagamaan melalui berbagai kegiatan komunitas.
            </p>
        </div>
                ...
                <div class="space-y-12">
                    <div class="space-y-6">
                        <div class="flex items-center gap-4">
                            ...
                            <h2 class="text-3xl font-black text-[#0F172A]">Tentang Rohis</h2>
                        </div>
                        <p class="text-base text-gray-500 leading-relaxed">
                            Rohis SMKS Mahaputra Cerdas Utama merupakan wadah pembinaan generasi muda untuk mengembangkan potensi, bakat, dan semangat positif secara islami. Anggota dilatih untuk memiliki karakter unggul, kedisiplinan, dan etika yang baik serta berprestasi dalam berbagai kegiatan.
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-2xl font-black text-[#0F172A] tracking-tight">50 Siswa</p>
                            </div>
                        </div>
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            <div class="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center text-blue-600">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-2xl font-black text-[#0F172A] tracking-tight">5+ Trophy</p>
                            </div>
                        </div>
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            <div class="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center text-blue-600">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-2xl font-black text-[#0F172A] tracking-tight">Sejak 2010</p>
                            </div>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="space-y-12">
                    ...
                    <div class="space-y-8">
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-lg font-bold text-[#0F172A]">Niat & Komitmen</h4>
                                <p class="text-sm text-gray-500">Memiliki niat tulus untuk memperbaiki diri, mendalami agama, dan berkomitmen mengikuti kegiatan rutin kerohanian.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-lg font-bold text-[#0F172A]">Sikap & Akhlak</h4>
                                <p class="text-sm text-gray-500">Memiliki akhlak yang baik dan bersedia menjadi teladan positif bagi siswa lain di lingkungan sekolah.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                <tr class="hover:bg-blue-50/30 transition-colors">
                                    <td class="px-8 py-6 font-bold text-[#0F172A]">Jumat</td>
                                    <td class="px-8 py-6 text-gray-500">15:00 - 16:30</td>
                                    <td class="px-8 py-6 text-gray-500 font-bold">Kajian & Mentoring</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="space-y-12">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                        <div class="aspect-square rounded-[1.5rem] overflow-hidden group cursor-pointer border border-gray-100 shadow-sm relative">
                            <img src="<?php echo e(asset('images/extracurriculars/thumbs/rohis.png')); ?>" class="w-full h-full object-cover transition-transform duration-700">
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="group space-y-4">
                            <div class="aspect-[4/3] rounded-[2rem] overflow-hidden shadow-lg border border-gray-100">
                                <img src="<?php echo e(asset('images/extracurriculars/thumbs/rohis.png')); ?>" class="w-full h-full object-cover transition-transform duration-500">
                            </div>
                            <div class="space-y-2">
                                ...
                                <h3 class="text-lg font-bold text-[#0F172A] group-hover:text-blue-600 transition-colors leading-snug">Prestasi Gemilang Rohis Tingkat Provinsi</h3>
                        ...
                        <div class="group space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <h3 class="text-xl font-bold text-[#0F172A] group-hover:text-blue-600 transition-colors leading-snug">Agenda Tahunan & Pelatihan Anggota Baru Rohis</h3>
                                <div class="flex items-center gap-3 pt-2">
                                    <div class="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center">
                                        <svg class="w-4 h-4 text-blue-600" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08s5.97 1.09 6 3.08c-1.29 1.94-3.5 3.22-6 3.22z"/></svg>
                                    </div>
            ...
            <div class="lg:col-span-4 space-y-8">
                ...
                <div class="bg-blue-600 rounded-[2rem] py-12 px-8 text-center space-y-8 shadow-2xl shadow-blue-500/20 relative overflow-hidden">
                    ...
                    <div class="relative z-10 p-6 bg-white/10 backdrop-blur-md rounded-[2rem] border border-white/20">
                        <a href="<?php echo e(route('extracurriculars.registration')); ?>" class="block w-full py-4 bg-white text-blue-600 rounded-2xl font-black text-base uppercase shadow-xl transition-all">
                            Daftar Sekarang
                        </a>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center gap-6 group">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Ketua Rohis</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="relative bg-[#0F172A] rounded-[2.5rem] p-12 lg:p-16 overflow-hidden shadow-2xl">
            ...
            <div class="relative z-10 text-center space-y-8">
                ...
                <div class="flex justify-center pt-8">
                     <a href="<?php echo e(route('extracurriculars.registration')); ?>" class="px-12 py-4 bg-blue-600 text-white rounded-2xl font-black text-lg uppercase shadow-xl shadow-blue-900 transition-all hover:bg-blue-700">
                        Daftar Rohis
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/extracurriculars/rohis.blade.php ENDPATH**/ ?>