        ...
        <div class="space-y-8 max-w-4xl">
            <div class="space-y-4">
                ...
                <h1 class="text-6xl lg:text-8xl font-black text-white leading-tight">
                    Kerohanian <br><span class="text-blue-500">Islam (Rohis)</span>
                </h1>
                ...
                <div class="space-y-12">
                    <div class="space-y-6">
                        <div class="flex items-center gap-4">
                            ...
                            <h2 class="text-4xl font-black text-[#0F172A]">Tentang Rohis</h2>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-3xl font-black text-[#0F172A] tracking-tight">50 Siswa</p>
                            </div>
                        </div>
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            <div class="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center text-blue-600">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-3xl font-black text-[#0F172A] tracking-tight">5+ Trophy</p>
                            </div>
                        </div>
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            <div class="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center text-blue-600">
                 ...
                 <div class="space-y-12">
                    ...
                    <div class="space-y-8">
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-xl font-bold text-[#0F172A]">Niat & Komitmen</h4>
                                <p class="text-gray-500">Memiliki niat tulus untuk memperbaiki diri, mendalami agama, dan berkomitmen mengikuti kegiatan rutin kerohanian.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-xl font-bold text-[#0F172A]">Sikap & Akhlak</h4>
                                <p class="text-gray-500">Memiliki akhlak yang baik dan bersedia menjadi teladan positif bagi siswa lain di lingkungan sekolah.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="group space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <h3 class="text-xl font-bold text-[#0F172A] group-hover:text-blue-600 transition-colors leading-snug">Prestasi Gemilang Rohis Tingkat Provinsi</h3>
            ...
            <div class="lg:col-span-4 space-y-8">
                ...
                <div class="bg-blue-600 rounded-[3rem] p-10 text-center space-y-8 shadow-2xl shadow-blue-500/20 relative overflow-hidden">
                    ...
                    <div class="relative z-10 p-6 bg-white/10 backdrop-blur-md rounded-[2rem] border border-white/20">
                        <a href="<?php echo e(route('extracurriculars.registration')); ?>" class="block w-full py-5 bg-white text-blue-600 rounded-2xl font-black text-lg uppercase shadow-xl transition-all">
                            Daftar Sekarang
                        </a>
