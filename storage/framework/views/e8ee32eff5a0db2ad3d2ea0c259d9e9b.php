...
<!-- Hero Section -->
<section class="relative pt-24 pb-24 lg:pb-32 bg-cover bg-center overflow-hidden animate-fade-in min-h-[50vh] lg:min-h-[65vh]" style="background-image: url('<?php echo e(asset('images/card.jpg')); ?>');">
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('seragamData', () => ({
            ...
            variants: [
                { label: 'Batik', baju: 'Baju Batik', celana: 'Celana/Rok Hitam', image: "<?php echo e(asset('images/seragam/selasa 2.jpg')); ?>" },
