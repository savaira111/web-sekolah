<?php $__env->startSection('title', 'Seragam Sekolah - SMKS Mahaputra'); ?>

<?php $__env->startSection('content'); ?>
<!-- Hero Section -->
<section class="relative pt-16 pb-16 lg:pb-20 bg-cover bg-center overflow-hidden animate-fade-in min-h-[40vh] lg:min-h-[50vh]" style="background-image: url('<?php echo e(asset('images/card.jpg')); ?>');">
...
<section class="pt-6 pb-24 bg-white relative z-10" x-data="{ 
    ...
    variants: [
        { label: 'Kotak-kotak', baju: 'Baju Kotak-kotak', celana: 'Celana/Rok Hitam', image: '<?php echo e(asset('images/seragam/selasa.jpg')); ?>' },
        { label: 'Batik', baju: 'Baju Batik Mahaputra', celana: 'Celana/Rok Abu-abu', image: '<?php echo e(asset('images/seragam/selasa 2.jpg')); ?>' }
    ],
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-6 xl:gap-8">
            ...
            <div class="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm hover:shadow-xl transition-all duration-300 group overflow-hidden">
                ...
                <div class="aspect-[4/3] rounded-2xl overflow-hidden mb-6 bg-gray-50 border border-gray-100">
                    <img src="<?php echo e(asset('images/seragam/senin.jpg')); ?>" alt="Seragam Senin" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                </div>
            ...
            <div class="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm hover:shadow-xl transition-all duration-300 group overflow-hidden">
                ...
                <div class="aspect-[4/3] rounded-2xl overflow-hidden mb-6 bg-gray-50 border border-gray-100">
                    <img src="<?php echo e(asset('images/seragam/rabu.jpg')); ?>" alt="Seragam Rabu" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                </div>
            ...
            <div class="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm hover:shadow-xl transition-all duration-300 group overflow-hidden">
                ...
                <div class="aspect-[4/3] rounded-2xl overflow-hidden mb-6 bg-gray-50 border border-gray-100">
                    <img src="<?php echo e(asset('images/seragam/kamis.jpg')); ?>" alt="Seragam Kamis" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                </div>
            ...
            <div class="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm hover:shadow-xl transition-all duration-300 group overflow-hidden">
                ...
                <div class="aspect-[4/3] rounded-2xl overflow-hidden mb-6 bg-gray-50 border border-gray-100">
                    <img src="<?php echo e(asset('images/seragam/jumat.jpg')); ?>" alt="Seragam Jumat" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                </div>
            ...
            <div class="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm hover:shadow-xl transition-all duration-300 group overflow-hidden">
                ...
                <div class="aspect-[4/3] rounded-2xl overflow-hidden mb-6 bg-gray-50 border border-gray-100">
                    <img src="<?php echo e(asset('images/seragam/olahraga.jpg')); ?>" alt="Seragam Olahraga" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/seragam.blade.php ENDPATH**/ ?>