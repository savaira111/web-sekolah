    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="max-w-5xl mx-auto bg-blue-600 rounded-[2.5rem] p-10 lg:p-14 text-center space-y-8 shadow-2xl shadow-blue-200 mt-20 relative overflow-hidden reveal reveal-scale">
             ...
             <div class="relative z-10 space-y-5">
                ...
                <div class="pt-4">
                    <a href="<?php echo e(route('registration')); ?>" class="inline-flex py-4 px-10 bg-white text-blue-600 rounded-2xl font-bold text-xl hover:scale-105 active:scale-95 transition-all shadow-xl shadow-blue-900/10">
