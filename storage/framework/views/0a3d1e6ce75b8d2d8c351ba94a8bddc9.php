<?php $__env->startSection('title', 'Panduan Pendaftaran & Biaya - SMKS Mahaputra'); ?>
...
<section class="relative pt-16 pb-24 bg-white overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="flex flex-col gap-16">
            <!-- Helper Navigation -->
            <div class="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-8">
                <div class="bg-green-50 p-8 rounded-[2.5rem] border border-green-100 flex flex-col justify-between">
                    <div>
                        <h4 class="font-bold text-green-900">Butuh Bantuan?</h4>
                        <p class="text-green-700 text-sm mt-3 mb-6">Tim CS kami siap membantu proses pendaftaran Anda.</p>
                    </div>
                ...
                <div class="bg-[#0F172A] p-8 rounded-[2.5rem] text-white flex flex-col justify-between shadow-xl shadow-blue-900/10">
                    <div>
                        <h4 class="font-bold">Brosur Digital</h4>
                        <p class="text-gray-400 text-sm mt-3 mb-6">Unduh informasi lengkap kurikulum & biaya.</p>
                    </div>
                    <a href="<?php echo e(asset('images/brosur-sekolah.jpg')); ?>" download="Brosur_SPMB_SMKS_Mahaputra_2026.jpg" class="flex items-center justify-center gap-2 w-full py-4 bg-white/10 border border-white/20 text-white rounded-2xl font-bold uppercase text-xs hover:bg-white/20 transition-all">
            ...
            <div class="max-w-6xl mx-auto w-full space-y-12">
                <!-- Biaya & Diskon Section (Bersisian agar mengurangi tinggi halaman) -->
                <div class="grid lg:grid-cols-12 gap-8 lg:gap-12">
                    <!-- Biaya Section -->
                    <div class="lg:col-span-5 space-y-6">
                        <h3 class="text-2xl font-bold text-blue-600">BIAYA MASUK AWAL</h3>
                        <div class="bg-blue-600 rounded-[2.5rem] p-10 h-auto lg:h-[calc(100%-3.5rem)] flex flex-col justify-center text-center text-white relative overflow-hidden shadow-2xl shadow-blue-200">
                            <div class="absolute inset-x-0 top-0 h-1/2 bg-gradient-to-b from-white/5 to-transparent"></div>
                            <p class="text-xs font-bold uppercase tracking-[0.2em] mb-4">PPDB 2026 - 2027</p>
                            <div class="flex items-baseline justify-center gap-2 mb-6">
                                <span class="text-xl font-bold opacity-60">Rp</span>
                                <span class="text-5xl lg:text-5xl xl:text-6xl font-bold leading-none">3.5<span class="text-4xl"> Juta</span></span>
                            </div>
                            <p class="text-blue-100 text-xs">Hanya dengan 3,5 Juta sudah bisa masuk di SMK Mahaputra Cerdas Utama</p>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-7 space-y-6">
                        ...
                        <div class="grid grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="bg-blue-600 p-6 rounded-[1.5rem] text-white text-center space-y-2 shadow-sm flex flex-col justify-center">
                            ...
                            <div class="bg-blue-600 p-6 rounded-[1.5rem] text-white text-center space-y-2 shadow-sm flex flex-col justify-center">
                                 <p class="text-[9px] font-bold uppercase tracking-widest opacity-60">DISKON</p>
                                <h4 class="text-3xl font-bold">75%</h4>
                             ...
                             <div class="bg-blue-500 p-6 rounded-[1.5rem] text-white text-center space-y-2 shadow-sm flex flex-col justify-center">
                                 <p class="text-[9px] font-bold uppercase tracking-widest opacity-60">DISKON</p>
                                <h4 class="text-3xl font-bold">25%</h4>
        ...
        <div class="bg-blue-600 rounded-[3rem] p-12 lg:p-20 text-center space-y-10 shadow-2xl shadow-blue-200 mt-20 relative overflow-hidden">
             ...
             <div class="relative z-10 space-y-6">
                ...
                <div class="pt-8">
                    <a href="<?php echo e(route('registration')); ?>" class="inline-flex py-6 px-16 bg-white text-blue-600 rounded-[2.5rem] font-bold text-2xl hover:scale-105 active:scale-95 transition-all shadow-xl shadow-blue-900/20">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/enrollment_guide.blade.php ENDPATH**/ ?>