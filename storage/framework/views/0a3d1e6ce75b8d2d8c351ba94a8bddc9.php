    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-[#0F172A] p-6 rounded-3xl text-white space-y-4 shadow-xl shadow-blue-900/10">
                    ...
                    <a href="<?php echo e(asset('images/brosur-sekolah.jpg')); ?>" download="Brosur_SPMB_SMKS_Mahaputra_2026.jpg" class="flex items-center justify-center gap-2 w-full py-3 bg-white/10 border border-white/20 text-white rounded-xl font-bold uppercase text-[11px] hover:bg-white/20 transition-all">
        ...
        <div class="bg-blue-600 rounded-[2rem] p-8 lg:p-12 text-center space-y-6 shadow-2xl shadow-blue-200 mt-12 relative overflow-hidden">
             ...
             <div class="relative z-10 space-y-4">
                ...
                <div class="pt-4">
                    <a href="<?php echo e(route('registration')); ?>" class="inline-flex py-4 px-10 bg-white text-blue-600 rounded-full font-bold text-xl hover:scale-105 active:scale-95 transition-all shadow-xl shadow-blue-900/20">
