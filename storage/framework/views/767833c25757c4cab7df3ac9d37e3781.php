    ...
    <div class="bg-gradient-to-br from-[#0F172A] to-blue-900 rounded-[2rem] p-10 lg:p-16 text-center relative overflow-hidden shadow-2xl reveal">
        ...
        <div class="relative z-10 space-y-6">
            ...
            <div class="flex flex-wrap justify-center gap-4 pt-6">
                <a href="<?php echo e(route('enrollment.guide')); ?>" class="px-6 py-3.5 bg-blue-600 text-white rounded-xl font-bold text-sm hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-900 transition-all uppercase tracking-wide">Daftar Online Sekarang</a>
