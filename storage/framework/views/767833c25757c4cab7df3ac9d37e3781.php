...
<section class="py-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid lg:grid-cols-2 gap-12 lg:gap-16">
        <!-- DKV Card -->
        <div class="group bg-white rounded-[1.5rem] border border-gray-100 overflow-hidden shadow-sm transition-all duration-500">
            ...
            <div class="p-5 space-y-4">
                ...
                <div class="pt-6 border-t border-gray-100">
                    <a href="<?php echo e(route('jurusan.dkv')); ?>" class="block w-full text-center py-3 px-4 border border-gray-100 rounded-xl font-bold text-sm text-gray-900 hover:bg-gray-50 hover:border-blue-200 hover:text-blue-600 transition-all">Lihat Detail Program</a>
                </div>
            </div>
        </div>
        ...
        <div class="group bg-white rounded-[1.5rem] border border-gray-100 overflow-hidden shadow-sm transition-all duration-500">
            ...
            <div class="p-5 space-y-4">
                ...
                <div class="pt-6 border-t border-gray-100">
                    <a href="<?php echo e(route('jurusan.pplg')); ?>" class="block w-full text-center py-3 px-4 border border-gray-100 rounded-xl font-bold text-sm text-gray-900 hover:bg-gray-50 hover:border-blue-200 hover:text-blue-600 transition-all">Lihat Detail Program</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10">
    <div class="bg-gradient-to-br from-[#0F172A] to-blue-900 rounded-[2rem] p-10 lg:p-16 text-center relative overflow-hidden shadow-2xl">
        ...
        <div class="relative z-10 space-y-6">
            ...
            <div class="flex flex-wrap justify-center gap-4 pt-6">
                <a href="<?php echo e(route('registration')); ?>" class="px-6 py-3.5 bg-blue-600 text-white rounded-xl font-bold text-sm hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-900 transition-all uppercase tracking-wide">Daftar Online Sekarang</a>
                <a href="<?php echo e(route('enrollment.guide')); ?>" class="px-6 py-3.5 bg-white/5 border border-white/20 text-white rounded-xl font-bold text-sm hover:bg-white/10 transition-all uppercase tracking-wide">Panduan Pendaftaran</a>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/programs.blade.php ENDPATH**/ ?>