    ...
    <div class="grid lg:grid-cols-2 gap-10">
        ...
        <div class="group bg-white rounded-[3rem] border border-gray-100 overflow-hidden shadow-sm transition-all duration-500">
            ...
            <div class="p-10 space-y-6">
                ...
                <div class="pt-8 border-t border-gray-100">
                    <a href="<?php echo e(route('jurusan.dkv')); ?>" class="block w-full text-center py-4 px-6 border border-gray-100 rounded-2xl font-bold text-gray-900 hover:bg-gray-50 hover:border-blue-200 hover:text-blue-600 transition-all">Lihat Detail Program</a>
                </div>
            </div>
        </div>
        ...
        <div class="group bg-white rounded-[3rem] border border-gray-100 overflow-hidden shadow-sm transition-all duration-500">
            ...
            <div class="p-10 space-y-6">
                ...
                <div class="pt-8 border-t border-gray-100">
                    <a href="<?php echo e(route('jurusan.pplg')); ?>" class="block w-full text-center py-4 px-6 border border-gray-100 rounded-2xl font-bold text-gray-900 hover:bg-gray-50 hover:border-blue-200 hover:text-blue-600 transition-all">Lihat Detail Program</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-br from-[#0F172A] to-blue-900 rounded-[3rem] p-10 lg:p-16 text-center relative overflow-hidden shadow-2xl">
        ...
        <div class="relative z-10 space-y-6">
            ...
            <div class="flex flex-wrap justify-center gap-5 pt-4">
                <a href="<?php echo e(route('registration')); ?>" class="px-8 py-4 bg-blue-600 text-white rounded-2xl font-bold text-lg hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-900 transition-all uppercase">Daftar Online Sekarang</a>
                <a href="<?php echo e(route('enrollment.guide')); ?>" class="px-8 py-4 bg-white/5 border border-white/20 text-white rounded-2xl font-bold text-lg hover:bg-white/10 transition-all uppercase">Panduan Pendaftaran</a>
            </div>
        </div>
    </div>
</section>
