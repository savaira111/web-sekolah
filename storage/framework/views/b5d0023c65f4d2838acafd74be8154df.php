<?php $__env->startSection('title', 'Tambah Album - Admin Mahput'); ?>
    ...
    function albumForm() {
        return {
            ...
            async submitForm() {
                ...
                try {
                    const response = await fetch("<?php echo e(route('superadmin.albums.store')); ?>", {
                        method: 'POST',
                        body: formData,
                        headers: {
...
<?php echo $__env->make('layouts.superadmin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/superadmin/albums/create.blade.php ENDPATH**/ ?>