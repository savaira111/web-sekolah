<?php $__env->startSection('title', 'Buat Artikel Baru - Admin Mahput'); ?>
...
<div class="px-8 pb-8 flex-1 w-full" :class="$store.theme.darkMode ? '' : 'bg-[#F3F4F6]'">
    ...
    <form id="articleForm" action="<?php echo e(route('superadmin.articles.store')); ?>" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.superadmin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/superadmin/articles/create.blade.php ENDPATH**/ ?>