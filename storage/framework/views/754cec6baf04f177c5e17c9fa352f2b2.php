<?php $__env->startSection('title', $album->title . ' - Galeri'); ?>
    ...
    <div class="pt-20 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="flex items-center gap-2 text-xs font-bold mb-8 uppercase tracking-widest text-slate-400">
                ...
                <a href="<?php echo e(route('album')); ?>" class="hover:text-blue-600 transition-colors">Galeri</a>
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/></svg>
            ...
            <div class="flex flex-col md:flex-row md:items-start lg:items-center gap-8">
                <!-- Back Button on LEFT -->
                <a href="<?php echo e(route('album')); ?>" class="w-12 h-12 flex items-center justify-center bg-white border border-slate-200 rounded-full text-[#0F172A] hover:bg-slate-50 hover:border-blue-200 transition-all shadow-sm group" title="Kembali">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex flex-wrap items-center gap-6 text-blue-600 font-bold text-sm">
                        <div class="flex items-center gap-2">
                            ...
                            <span><?php echo e($album->category); ?></span>
                        </div>
                        <div class="flex items-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                            <span><?php echo e(\Carbon\Carbon::parse($album->event_date)->translatedFormat('d F Y')); ?></span>
                        </div>
                        <div class="flex items-center gap-2">
                            ...
                            <span><?php echo e($album->photos->count()); ?> Foto</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-blue-50/40 border-l-[6px] border-blue-600 rounded-[2rem] p-10 md:p-12">
                ...
                <div class="text-[#64748B] leading-relaxed text-lg font-medium max-w-5xl">
                    <?php echo e($album->description ?? 'Tidak ada deskripsi untuk album ini.'); ?>
                ...
                <?php $__currentLoopData = $album->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div x-data="{ open: false }" class="group">
                        <div @click="open = true" class="aspect-[4/3] rounded-[2rem] overflow-hidden border border-slate-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-700 cursor-zoom-in relative">
                            <img src="<?php echo e(asset('storage/' . $photo->path)); ?>" alt="Dokumentasi SMKS Mahaputra" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110">
                        ...
                        <div x-show="open" 
                            ...
                            <img :src="'<?php echo e(asset('storage/' . $photo->path)); ?>'" class="max-w-full max-h-[85vh] rounded-3xl shadow-2xl border-4 border-white/10">
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/album_detail.blade.php ENDPATH**/ ?>