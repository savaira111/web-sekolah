                ...
                <div class="mt-10 pt-8 border-t border-gray-100 flex flex-wrap items-center justify-between gap-8">
                    ...
                    <div class="flex items-center gap-4" x-data="{ 
                        ...
                        <div class="flex items-center gap-3 relative">
                            ...
                            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url()->current())); ?>" target="_blank" class="w-9 h-9 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:bg-blue-600 hover:text-white transition-all shadow-sm">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
                            </a>
                            <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($article->title)); ?>" target="_blank" class="w-9 h-9 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:bg-blue-400 hover:text-white transition-all shadow-sm">
                    ...
                    function commentSystem() {
                        return {
                            ...
                            addComment() {
                                ...
                                fetch(`<?php echo e(route('news.comments.store', $article->id)); ?>`, {
                                    method: 'POST',
                                    headers: {
            ...
            <aside class="lg:col-span-4 space-y-10">
                ...
                <div class="relative p-6 rounded-[1.5rem] bg-gradient-to-br from-blue-600 to-blue-800 text-white overflow-hidden shadow-2xl shadow-blue-500/40 group">
                    ...
                    <div class="relative z-10 space-y-4">
                        ...
                        <a href="<?php echo e(route('enrollment.guide')); ?>" class="block w-full py-4 bg-white text-blue-600 text-center rounded-2xl font-black text-sm shadow-xl hover:bg-blue-50 hover:scale-[1.02] active:scale-[0.98] transition-all">
                            Daftar Sekarang
                        </a>
                    </div>
                </div>
