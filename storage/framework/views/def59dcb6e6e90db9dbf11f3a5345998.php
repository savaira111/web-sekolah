...
<section id="explore" class="py-10 bg-white" x-data="{ active: 'semua' }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            ...
            <button @click="active = 'wajib'" :class="active === 'wajib' ? 'bg-blue-50 text-blue-600 shadow-sm' : 'bg-gray-50 text-gray-500'" class="px-8 py-3 rounded-xl font-bold text-xs uppercase tracking-widest transition-all">Wajib</button>
            ...
            <button @click="active = 'kepemimpinan'" :class="active === 'kepemimpinan' ? 'bg-blue-50 text-blue-600 shadow-sm' : 'bg-gray-50 text-gray-500'" class="px-8 py-3 rounded-xl font-bold text-xs uppercase tracking-widest transition-all">Kepemimpinan</button>
            <button @click="active = 'keagamaan'" :class="active === 'keagamaan' ? 'bg-blue-50 text-blue-600 shadow-sm' : 'bg-gray-50 text-gray-500'" class="px-8 py-3 rounded-xl font-bold text-xs uppercase tracking-widest transition-all">Keagamaan</button>
            <button @click="active = 'seni-beladiri'" :class="active === 'seni-beladiri' ? 'bg-blue-50 text-blue-600 shadow-sm' : 'bg-gray-50 text-gray-500'" class="px-8 py-3 rounded-xl font-bold text-xs uppercase tracking-widest transition-all">Seni Beladiri</button>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="<?php echo e(route('extracurriculars.show', $eskul->id)); ?>" 
               <?php
                    ...
                    elseif (str_contains($cat, 'wajib')) $normCat = 'wajib';
