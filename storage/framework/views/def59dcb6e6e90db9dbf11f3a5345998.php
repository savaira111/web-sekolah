        ...
        <div class="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-wrap gap-4 pt-4">
                    <a href="<?php echo e(route('extracurriculars.registration')); ?>" class="px-10 py-5 bg-blue-600 text-white rounded-2xl font-black shadow-xl shadow-blue-200 hover:bg-blue-700 transition-all uppercase tracking-wide">Daftar sekarang</a>
                    <a href="<?php echo e(route('profile')); ?>" class="px-10 py-5 bg-gray-100 text-[#0F172A] rounded-2xl font-black hover:bg-gray-200 transition-all uppercase tracking-wide">Profil Sekolah</a>
                </div>
            </div>

            <!-- Right Side: Poster Card Image -->
            <div class="relative group lg:justify-self-end">
                <div class="relative z-10 w-full lg:w-[440px] aspect-square rounded-[1.5rem] overflow-hidden shadow-2xl shadow-blue-900/10 border-8 border-white">
            ...
            <a href="<?php echo e(route('extracurriculars.show', $eskul->id)); ?>" 
               ...
               class="group space-y-4">
                <div class="aspect-[4/3] rounded-[1.5rem] overflow-hidden shadow-xl relative">
                    <?php
                        $thumb = asset('images/extracurriculars/thumbs/default.png');
                        if ($eskul->image) {
                    ...
                    ?>
                    <img src="<?php echo e($thumb); ?>" alt="<?php echo e($eskul->name); ?>" class="w-full h-full object-cover transition-transform duration-700 font-medium group-hover:scale-105">
