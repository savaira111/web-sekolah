<?php $__env->startSection('title', 'Pendaftaran Eskul - SMKS Mahaputra'); ?>
        ...
        <div class="mb-8">
            <div class="flex flex-col md:flex-row md:items-start justify-between gap-6">
                <div class="flex items-start gap-4">
                    <a href="<?php echo e(route('extracurriculars.index')); ?>" class="inline-flex items-center justify-center w-12 h-12 bg-white border border-gray-200 text-blue-600 rounded-full hover:bg-blue-50 hover:border-blue-200 transition-all shadow-sm shrink-0" title="Kembali">
        ...
        <div class="grid lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-8 space-y-12">
                ...
                <div class="bg-white rounded-[1.5rem] p-6 shadow-sm border border-gray-100">
                    ...
                    <form action="<?php echo e(route('extracurriculars.registration.store')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="relative">
                                <select name="extracurricular" required class="w-full p-5 bg-gray-50 rounded-2xl border-none focus:ring-2 focus:ring-blue-100 text-sm text-gray-700 appearance-none">
                                    ...
                                    <?php $__currentLoopData = $extracurriculars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eskul): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($eskul->name); ?>"><?php echo e($eskul->name); ?></option>
                            ...
                            <tbody class="divide-y divide-gray-50">
                                <?php $__currentLoopData = $extracurriculars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eskul): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="group hover:bg-gray-50/30 transition-colors">
                                        <td class="px-6 py-5 font-bold text-[#0F172A]"><?php echo e($eskul->name); ?></td>
                                        <td class="px-6 py-5 text-gray-500">
                                            <?php if($eskul->weekly_schedule): ?>
                                                <?php echo e(implode(', ', array_keys($eskul->weekly_schedule))); ?>
                                        ...
                                        <td class="px-6 py-5 text-gray-500">
                                            <?php if($eskul->weekly_schedule): ?>
                                                <?php $__currentLoopData = $eskul->weekly_schedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day => $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php echo e($time); ?><?php echo e(!$loop->last ? ', ' : ''); ?>
                                        ...
                                        <td class="px-6 py-5 text-gray-500 font-bold"><?php echo e($eskul->schedule_info ?? 'TBA'); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/extracurriculars/registration.blade.php ENDPATH**/ ?>