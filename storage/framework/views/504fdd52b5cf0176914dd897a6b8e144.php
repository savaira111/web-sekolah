<?php $__env->startSection('title', 'Buat Eskul Baru - Admin Mahput'); ?>
...
<div class="px-8 pb-8 flex-1 w-full overflow-x-auto" x-data="eskulForm()">
    ...
    <div class="flex items-center gap-2 mb-4 text-[11px] font-extrabold uppercase tracking-widest transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-500' : 'text-gray-400'">
        <a href="<?php echo e(route('superadmin.eskul.index')); ?>" class="hover:text-blue-600 transition-colors">Manajemen Eskul</a>
    ...
    <form x-ref="form" action="<?php echo e(route('superadmin.eskul.store')); ?>" method="POST" @submit.prevent="submitForm()" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.superadmin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/superadmin/eskul/create.blade.php ENDPATH**/ ?>