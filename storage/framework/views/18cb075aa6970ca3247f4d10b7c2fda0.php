<?php $__env->startSection('title', 'User Management - Admin Mahput'); ?>
...
<div x-data="{ 
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-8 mb-8 gap-4">
        <div>
            <h2 class="text-[32px] font-extrabold tracking-tight leading-none mb-2 transition-colors duration-300" :class="$store.theme.darkMode ? 'text-white' : 'text-gray-900'">Manajemen Pengguna</h2>
            <p class="text-sm font-medium transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-400' : 'text-gray-500'">Kelola akses dan hak akses untuk staf sekolah.</p>
        </div>
        
        <div class="flex items-center gap-3">
            <button @click="showTrash = !showTrash" class="p-2.5 rounded-xl border flex items-center gap-2 transition-all font-bold text-sm" :class="$store.theme.darkMode ? 'bg-gray-800 border-gray-700 text-gray-300' : 'bg-white border-gray-200 text-gray-600'">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                Trash (<span x-text="trash.length"></span>)
            </button>

            <div class="relative mr-2">
                <input type="text" x-model="searchQuery" placeholder="Cari nama pengguna..." class="pl-10 pr-4 py-2.5 rounded-xl text-sm border focus:ring-2 transition-all outline-none" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-700 text-white focus:ring-blue-500/20' : 'bg-white border-gray-200 text-gray-900 focus:ring-blue-500/10'">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="rounded-3xl p-6 shadow-sm border transition-colors duration-300 flex items-center gap-5" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-800' : 'bg-white border-gray-100/50'">
            <div class="w-14 h-14 rounded-full flex items-center justify-center transition-colors duration-300" :class="$store.theme.darkMode ? 'bg-blue-50/10' : 'bg-blue-50'">
            ...
            <div>
                <p class="text-[11px] font-bold tracking-wider uppercase mb-1 transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-400' : 'text-gray-500'">Total Pengguna Aktif</p>
                <h3 class="text-3xl font-extrabold leading-none transition-colors duration-300" :class="$store.theme.darkMode ? 'text-white' : 'text-gray-900'" x-text="users.length"></h3>
            </div>
        </div>
        <div class="rounded-3xl p-6 shadow-sm border transition-colors duration-300 flex items-center gap-5" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-800' : 'bg-white border-gray-100/50'">
            <div class="w-14 h-14 rounded-full flex items-center justify-center transition-colors duration-300" :class="$store.theme.darkMode ? 'bg-emerald-50/10' : 'bg-emerald-50'">
            ...
            <div>
                <p class="text-[11px] font-bold tracking-wider uppercase mb-1 transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-400' : 'text-gray-500'">Total Admin</p>
                <h3 class="text-3xl font-extrabold leading-none transition-colors duration-300" :class="$store.theme.darkMode ? 'text-white' : 'text-gray-900'" x-text="users.filter(u => u.role === 'Admin').length"></h3>
            </div>
        </div>
        <div class="rounded-3xl p-6 shadow-sm border transition-colors duration-300 flex items-center gap-5" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-800' : 'bg-white border-gray-100/50'">
            <div class="w-14 h-14 rounded-full flex items-center justify-center transition-colors duration-300" :class="$store.theme.darkMode ? 'bg-amber-50/10' : 'bg-amber-50'">
                <svg class="w-7 h-7 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
            </div>
            <div>
                <p class="text-[11px] font-bold tracking-wider uppercase mb-1 transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-400' : 'text-gray-500'">Total Editor</p>
                <h3 class="text-3xl font-extrabold leading-none transition-colors duration-300" :class="$store.theme.darkMode ? 'text-white' : 'text-gray-900'" x-text="users.filter(u => u.role === 'Editor').length"></h3>
            </div>
        </div>
    </div>
            ...
            <table class="w-full text-left min-w-[800px]">
                <thead>
                    <tr class="border-b transition-colors duration-300" :class="$store.theme.darkMode ? 'border-gray-800' : 'border-gray-100'">
                        <th class="pb-4 text-[11px] font-bold uppercase tracking-wider pl-2 transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-500' : 'text-gray-400'">Pengguna</th>
                        <th class="pb-4 text-[11px] font-bold uppercase tracking-wider transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-500' : 'text-gray-400'">Email</th>
                        <th class="pb-4 text-[11px] font-bold uppercase tracking-wider transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-500' : 'text-gray-400'">Peran</th>
                ...
                <tbody class="text-[13px]">
                    <template x-for="user in filteredUsers" :key="user.id">
                        <tr class="border-b last:border-0 transition-colors group" :class="$store.theme.darkMode ? 'border-gray-800 hover:bg-black/20/50' : 'border-gray-50 hover:bg-gray-50/50'">
                            <td class="py-5 font-bold transition-colors duration-300 pl-2" :class="$store.theme.darkMode ? 'text-white' : 'text-gray-900'">
                                <div class="flex items-center gap-4">
                                    <div class="w-10 h-10 rounded-full overflow-hidden border" :class="$store.theme.darkMode ? 'border-gray-700' : 'border-gray-200'">
                            ...
                            <td class="py-5 text-right pr-2">
                                <div class="flex items-center justify-end gap-1">
                                    <button @click="openEditModal(user)" class="w-8 h-8 rounded-full flex items-center justify-center transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-400 hover:bg-gray-800 hover:text-white' : 'text-gray-400 hover:bg-gray-100 hover:text-gray-700'">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                    </button>
                                    <button @click="confirmDelete(user)" class="w-8 h-8 rounded-full flex items-center justify-center transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-400 hover:bg-red-500/10 hover:text-red-400' : 'text-gray-400 hover:bg-red-50 hover:text-red-500'">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                                    </button>
                                </div>
                            </td>
    ...
    <div x-show="showTrash" x-transition.opacity class="rounded-[2.5rem] p-8 shadow-sm border mb-4 transition-colors duration-300" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-800' : 'bg-white border-gray-100/50'">
        <div class="flex items-center justify-between mb-8 pb-4 border-b transition-colors duration-300" :class="$store.theme.darkMode ? 'border-gray-800' : 'border-gray-100'">
            <div class="flex items-center gap-4">
                <button @click="showTrash = false" class="p-2 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors" :class="$store.theme.darkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-gray-50'">
                ...
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-full bg-red-50 flex items-center justify-center" :class="$store.theme.darkMode ? 'bg-red-500/10' : 'bg-red-50'">
                    ...
                    <h3 class="text-xl font-bold" :class="$store.theme.darkMode ? 'text-white' : 'text-gray-900'">Tempat Sampah</h3>
                </div>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left min-w-[800px]">
                <thead>
                    <tr class="text-[11px] font-bold uppercase tracking-wider" :class="$store.theme.darkMode ? 'text-gray-500' : 'text-gray-400'">
                ...
                <tbody class="text-[13px]">
                    <template x-for="item in trash" :key="item.id">
                        <tr class="border-b last:border-0" :class="$store.theme.darkMode ? 'border-gray-800' : 'border-gray-50'">
                            <td class="py-5 font-bold pl-2" :class="$store.theme.darkMode ? 'text-white' : 'text-gray-900'">
                                <div class="flex items-center gap-4">
                                    <img :src="item.image" class="w-10 h-10 rounded-full opacity-60">
                                    <span x-text="item.name"></span>
                                </div>
                            </td>
                            <td class="py-5 font-medium" :class="$store.theme.darkMode ? 'text-gray-400' : 'text-gray-500'" x-text="item.deleted_at"></td>
                            <td class="py-5">
        ...
        <div class="relative w-full max-w-[700px] p-8 rounded-[2rem] shadow-2xl max-h-[90vh] overflow-y-auto transition-colors duration-300" :class="$store.theme.darkMode ? 'bg-gray-900 border border-gray-800 text-white' : 'bg-white text-gray-900'">
             <div class="flex items-start justify-between mb-8">
                <div>
                    ...
                    <p class="text-[13px] font-medium" :class="$store.theme.darkMode ? 'text-gray-400' : 'text-gray-500'">Daftarkan staf atau editor baru.</p>
                </div>
            </div>
            <form @submit.prevent="addUser" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-extrabold mb-2" :class="$store.theme.darkMode ? 'text-gray-300' : 'text-gray-700'">Nama Lengkap</label>
                        <input type="text" x-model="newUser.name" required class="w-full px-5 py-3 rounded-2xl border text-sm outline-none" :class="$store.theme.darkMode ? 'bg-black/20 border-gray-700 text-white' : 'bg-white border-gray-200 text-gray-900'">
                    </div>
                    <div>
                        <label class="block text-xs font-extrabold mb-2" :class="$store.theme.darkMode ? 'text-gray-300' : 'text-gray-700'">Email</label>
                        <input type="email" x-model="newUser.email" required class="w-full px-5 py-3 rounded-2xl border text-sm outline-none" :class="$store.theme.darkMode ? 'bg-black/20 border-gray-700 text-white' : 'bg-white border-gray-200 text-gray-900'">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 items-start">
                    <div>
                        <label class="block text-xs font-extrabold mb-2" :class="$store.theme.darkMode ? 'text-gray-300' : 'text-gray-700'">Password</label>
                        <div class="relative">
                            <input :type="showPw ? 'text' : 'password'" x-model="newUser.password" required class="w-full px-5 py-3 rounded-2xl border text-sm outline-none" :class="$store.theme.darkMode ? 'bg-black/20 border-gray-700 text-white' : 'bg-white border-gray-200 text-gray-900'">
        ...
        <div class="relative w-full max-w-[700px] p-8 rounded-[2rem] shadow-2xl max-h-[90vh] overflow-y-auto transition-colors duration-300" :class="$store.theme.darkMode ? 'bg-gray-900 border border-gray-800 text-white' : 'bg-white text-gray-900'">
            <div class="flex items-start justify-between mb-8">
                <div>
                    ...
                    <p class="text-[13px] font-medium" :class="$store.theme.darkMode ? 'text-gray-400' : 'text-gray-500'">Perbarui data atau ubah password staf.</p>
                </div>
            </div>
            <form @submit.prevent="updateUser" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-extrabold mb-2" :class="$store.theme.darkMode ? 'text-gray-300' : 'text-gray-700'">Nama Lengkap</label>
                        <input type="text" x-model="editingUser.name" required class="w-full px-5 py-3 rounded-2xl border text-sm outline-none" :class="$store.theme.darkMode ? 'bg-black/20 border-gray-700 text-white' : 'bg-white border-gray-200 text-gray-900'">
                    </div>
                    <div>
                        <label class="block text-xs font-extrabold mb-2" :class="$store.theme.darkMode ? 'text-gray-300' : 'text-gray-700'">Email</label>
                        <input type="email" x-model="editingUser.email" required class="w-full px-5 py-3 rounded-2xl border text-sm outline-none" :class="$store.theme.darkMode ? 'bg-black/20 border-gray-700 text-white' : 'bg-white border-gray-200 text-gray-900'">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="password" x-model="editingUser.password" class="w-full px-5 py-3 rounded-2xl border text-sm outline-none" :class="$store.theme.darkMode ? 'bg-black/20 border-gray-700 text-white' : 'bg-white border-gray-200 text-gray-900'">
                    </div>
                    <div>
                        <label class="block text-xs font-extrabold mb-2" :class="$store.theme.darkMode ? 'text-gray-300' : 'text-gray-700'">Peran</label>
...
<?php echo $__env->make('layouts.superadmin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/superadmin/users/index.blade.php ENDPATH**/ ?>