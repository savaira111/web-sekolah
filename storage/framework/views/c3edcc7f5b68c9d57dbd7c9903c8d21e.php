<?php $__env->startSection('title', 'Edit Album - Admin Mahput'); ?>
...
<div x-data="albumForm()" class="px-8 pb-8 flex-1 w-full max-w-[1400px]">
    ...
    <div class="flex items-center justify-between mt-6 mb-4">
        <div class="flex items-center gap-2 text-xs font-medium text-gray-400">
            <a href="<?php echo e(route('superadmin.albums.index')); ?>" class="hover:text-blue-500 transition-colors">Manajemen Album</a>
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <h2 class="text-2xl font-extrabold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-white' : 'text-gray-900'">Edit Album: <?php echo e($album->title); ?></h2>
    </div>
            ...
            <div class="rounded-[2rem] p-8 shadow-sm border transition-colors duration-300" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-800' : 'bg-white border-gray-100/50'">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="title" value="<?php echo e($album->title); ?>" required class="w-full px-5 py-3.5 rounded-xl border outline-none transition-all duration-300" :class="$store.theme.darkMode ? 'bg-black border-gray-700 text-white focus:border-blue-500' : 'bg-white border-gray-200 text-gray-900 focus:border-blue-500'">
                    </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select name="category" required class="w-full px-5 py-3.5 rounded-xl border outline-none appearance-none transition-all duration-300" :class="$store.theme.darkMode ? 'bg-black border-gray-700 text-white focus:border-blue-500' : 'bg-white border-gray-200 text-gray-900 focus:border-blue-500'">
                                    <option value="Akademik" <?php echo e($album->category == 'Akademik' ? 'selected' : ''); ?>>Akademik</option>
                                    <option value="Kesiswaan" <?php echo e($album->category == 'Kesiswaan' ? 'selected' : ''); ?>>Kesiswaan</option>
                                    <option value="Prestasi" <?php echo e($album->category == 'Prestasi' ? 'selected' : ''); ?>>Prestasi</option>
                                    <option value="Fasilitas" <?php echo e($album->category == 'Fasilitas' ? 'selected' : ''); ?>>Fasilitas</option>
                                </select>
...
<script>
    function albumForm() {
        return {
            isToggled: <?php echo e($album->is_visible ? 'true' : 'false'); ?>,
            uploadedPhotos: [
                ...
                { id: <?php echo e($photo->id); ?>, src: '<?php echo e(asset('storage/' . $photo->path)); ?>', isOld: true },
            ...
            async submitForm() {
                ...
                try {
                    const response = await fetch("<?php echo e(route('superadmin.albums.update', $album)); ?>", {
...
<?php echo $__env->make('layouts.superadmin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/superadmin/albums/edit.blade.php ENDPATH**/ ?>