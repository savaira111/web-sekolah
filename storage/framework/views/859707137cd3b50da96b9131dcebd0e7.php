<?php $__env->startSection('title', 'Edit Artikel - Admin Mahput'); ?>
...
<div class="p-6 lg:p-10 min-h-screen" :class="$store.theme.darkMode ? '' : 'bg-gray-50'">
    ...
    <nav class="flex mb-6 text-sm" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2">
            ...
            <li class="flex items-center space-x-2">
                ...
                <a href="<?php echo e(route('superadmin.articles.index')); ?>" class="text-gray-500 hover:text-blue-600">Artikel / Berita</a>
            </li>
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
        <div class="flex items-start space-x-5">
            <a href="<?php echo e(route('superadmin.articles.index')); ?>" 
        ...
        <div class="mt-6 lg:mt-0 flex items-center space-x-3">
            <button type="button" onclick="submitForm(<?php echo e($article->is_published ? 1 : 0); ?>)" class="px-8 py-3 rounded-xl font-bold text-sm bg-blue-600 text-white hover:bg-blue-700 shadow-xl shadow-blue-500/20 active:scale-95 transition-all whitespace-nowrap">
                Simpan Perubahan
            </button>
        </div>
    </div>

    <form id="articleForm" action="<?php echo e(route('superadmin.articles.update', $article)); ?>" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        <input type="hidden" name="is_published" id="is_published" value="<?php echo e($article->is_published ? 1 : 0); ?>">
                ...
                <div class="space-y-3">
                    ...
                    <div class="rounded-2xl overflow-hidden border transition-all duration-200 shadow-inner" 
                        ...
                        <div id="editor-container" class="bg-transparent">
                            <div id="editor" class="min-h-[600px] text-lg leading-relaxed"><?php echo old('content', $article->content); ?></div>
                        </div>
            ...
            <div class="rounded-3xl p-6 shadow-xl transition-all duration-200"
                ...
                <div class="relative group">
                    ...
                    <label for="featured_image" 
                        ...
                        <div id="image-preview-container" class="<?php echo e($article->featured_image ? '' : 'hidden'); ?> w-full mb-4 rounded-xl overflow-hidden aspect-video">
                            <img id="image-preview" src="<?php echo e($article->featured_image ? asset('storage/' . $article->featured_image) : '#'); ?>" alt="Preview" class="w-full h-full object-cover">
                        </div>

                        <div id="upload-placeholder" class="<?php echo e($article->featured_image ? 'hidden' : ''); ?> text-center">
                        ...
                        <div class="relative group">
                            <select name="category" id="category" class="w-full appearance-none px-4 py-3 rounded-xl border font-medium focus:ring-0 transition-all duration-200"
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(old('category', $article->category) == $key ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                ...
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="is_published_toggle" value="1" <?php echo e($article->is_published ? 'checked' : ''); ?> class="sr-only peer" 
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="is_highlighted" value="1" <?php echo e($article->is_highlighted ? 'checked' : ''); ?> class="sr-only peer">
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="allow_comments" value="1" <?php echo e($article->allow_comments ? 'checked' : ''); ?> class="sr-only peer">
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.superadmin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/superadmin/articles/edit.blade.php ENDPATH**/ ?>