...
<section class="pb-8 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div id="staff-grid" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-8 gap-y-16">
            ...
            <div class="staff-card group text-center space-y-4 transition-all duration-300 reveal reveal-scale" style="transition-delay: <?php echo e($loop->index * 50); ?>ms" data-category="<?php echo e($person['category']); ?>">
                ...
                <div class="relative inline-block">
                    <div class="w-40 h-40 lg:w-48 lg:h-48 rounded-full overflow-hidden border-4 border-white shadow-xl relative z-10 transition-transform duration-500 group-hover:scale-105">
                        <img src="<?php echo e(asset($person['img'])); ?>" alt="<?php echo e($person['name']); ?>" class="w-full h-full object-cover">
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/staff.blade.php ENDPATH**/ ?>