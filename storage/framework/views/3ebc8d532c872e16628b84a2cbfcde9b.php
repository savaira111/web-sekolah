    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-12 gap-16">
            ...
            <div class="lg:col-span-8 space-y-20">
                ...
                <div class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm space-y-3 group transition-all duration-500">
                            ...
                            <div class="space-y-0.5">
                                ...
                                <p class="text-2xl font-bold text-[#0F172A] tracking-tight">45 Siswa</p>
                            </div>
                        </div>
                        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm space-y-3 group transition-all duration-500">
                            <div class="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600">
                            ...
                            <div class="space-y-0.5">
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Penghargaan</p>
                                <p class="text-2xl font-bold text-[#0F172A] tracking-tight">25+ Trophy</p>
                            </div>
                        </div>
                        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm space-y-3 group transition-all duration-500">
                            <div class="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600">
                            ...
                            <div class="space-y-0.5">
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Berdiri</p>
                                <p class="text-2xl font-bold text-[#0F172A] tracking-tight">Sejak 2010</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Requirements -->
                 <div class="space-y-8">
                     <div class="flex items-center gap-3">
                        <div class="w-1.5 h-8 bg-blue-600 rounded-full"></div>
                        <h2 class="text-2xl font-bold text-[#0F172A]">Syarat Masuk & Seleksi</h2>
                    </div>
                    <div class="space-y-6">
                        <div class="flex gap-4 group">
                            <div class="w-10 h-10 bg-white border border-gray-100 rounded-xl shadow-sm flex items-center justify-center text-sm font-bold text-blue-600 shrink-0 group-hover:bg-blue-600 group-hover:text-white transition-all duration-500">1</div>
                            <div class="space-y-1">
                                <h4 class="text-lg font-bold text-[#0F172A]">Kriteria Utama</h4>
                                <p class="text-sm text-gray-500">Siswa/i SMKS Mahaputra Cerdas Utama yang memiliki minat dan bakat di bidang extracurricular ini.</p>
                            </div>
                        </div>
                        <div class="flex gap-4 group">
                            <div class="w-10 h-10 bg-white border border-gray-100 rounded-xl shadow-sm flex items-center justify-center text-sm font-bold text-blue-600 shrink-0 group-hover:bg-blue-600 group-hover:text-white transition-all duration-500">2</div>
                            <div class="space-y-1">
                                <h4 class="text-lg font-bold text-[#0F172A]">Kesehatan & Stamina</h4>
                                <p class="text-sm text-gray-500">Lulus tes kesehatan, tidak memiliki riwayat penyakit berat, serta memiliki stamina untuk latihan rutin.</p>
                            </div>
                        </div>
                        <div class="flex gap-4 group">
                            <div class="w-10 h-10 bg-white border border-gray-100 rounded-xl shadow-sm flex items-center justify-center text-sm font-bold text-blue-600 shrink-0 group-hover:bg-blue-600 group-hover:text-white transition-all duration-500">3</div>
                            <div class="space-y-1">
                ...
                <div class="space-y-8">
                     <div class="flex items-center gap-3">
                        <div class="w-1.5 h-8 bg-blue-600 rounded-full"></div>
                        <h2 class="text-2xl font-bold text-[#0F172A]">Jadwal Latihan Rutin</h2>
                    </div>
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                        <table class="w-full text-left text-sm">
                            <thead>
                                <tr class="bg-gray-50 border-b border-gray-100">
                                    <th class="px-5 py-4 text-xs font-bold text-gray-400 uppercase tracking-wider">Hari</th>
                                    <th class="px-5 py-4 text-xs font-bold text-gray-400 uppercase tracking-wider">Waktu</th>
                                    <th class="px-5 py-4 text-xs font-bold text-gray-400 uppercase tracking-wider">Keterangan</th>
                                </tr>
                            </thead>
                ...
                <div class="space-y-8">
                    <div class="flex items-center gap-3">
                        <div class="w-1.5 h-8 bg-blue-600 rounded-full"></div>
                        <h2 class="text-2xl font-bold text-[#0F172A]">Galeri Kegiatan</h2>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="group space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <h3 class="text-xl font-bold text-[#0F172A] group-hover:text-blue-600 transition-colors leading-snug">Agenda Tahunan & Pelatihan Anggota Baru</h3>
                                <div class="flex items-center gap-3 pt-2">
                                    <div class="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center">
                                        <svg class="w-4 h-4 text-blue-600" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08s5.97 1.09 6 3.08c-1.29 1.94-3.5 3.22-6 3.22z"/></svg>
                                    </div>
            ...
            <div class="lg:col-span-4 space-y-8">
                ...
                <div class="bg-blue-600 rounded-2xl p-6 text-center space-y-6 shadow-xl shadow-blue-500/20 relative overflow-hidden">
                    ...
                    <div class="relative z-10 space-y-2">
                        <h4 class="text-2xl font-bold text-white leading-tight uppercase">Siap Bergabung?</h4>
                        <p class="text-xs text-blue-100">Jadilah bagian dari ekstrakurikuler unggulan sekolah. Pendaftaran sedang dibuka sekarang!</p>
                    </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 p-6 space-y-6 shadow-sm">
                    <h4 class="text-lg font-bold text-[#0F172A] border-l-4 border-blue-600 pl-3">Pembina & Ketua</h4>
                    <div class="space-y-4">
                        <div class="flex items-center gap-4 group">
                            <div class="relative">
                                <img src="https://ui-avatars.com/api/?name=Pembina+Utama&background=random" class="w-12 h-12 rounded-xl object-cover shadow-md transition-transform duration-500">
                        ...
                        <div class="flex items-center gap-4 group">
                            <div class="relative">
                                <img src="https://ui-avatars.com/api/?name=Ketua+Eskul&background=random" class="w-12 h-12 rounded-xl object-cover shadow-md transition-transform duration-500">
                                <div class="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-green-500 border border-white rounded-full"></div>
                            </div>
                            <div class="space-y-0.5">
                                <p class="font-bold text-[#0F172A] text-sm">Ketua Terpilih</p>
                                <p class="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Ketua Eskul</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 p-6 space-y-4 shadow-sm">
                    <div class="space-y-0.5">
                        ...
                        <p class="text-[9px] text-gray-400">Kampus SMKS Mahaputra Cerdas Utama</p>
                    </div>
                    <div class="relative aspect-[4/3] rounded-xl overflow-hidden border border-gray-100 group">
                    ...
                    <div class="space-y-1 pt-1 text-xs">
                        <p class="font-bold text-[#0F172A]">Area Sekolah</p>
                        <p class="text-[10px] text-gray-500 leading-relaxed">Gedung Utama, Jl. Raya Cilampeni No.19, Katapang, Kabupaten Bandung.</p>
                    </div>
                </div>
