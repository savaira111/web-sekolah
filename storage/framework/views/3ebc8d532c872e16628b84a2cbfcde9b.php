...
<section class="relative min-h-screen flex items-start pt-16 lg:pt-20 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div class="space-y-8 max-w-4xl">
            <div class="space-y-4">
                <span class="inline-block px-4 py-1.5 bg-blue-600 text-white text-[10px] font-bold rounded-lg uppercase tracking-wider"><?php echo e($eskul->category ?? 'Ekstrakurikuler'); ?></span>
                            ...
                            <tbody class="divide-y divide-gray-50">
                                ...
                                <?php if($schedule && is_array($schedule) && count($schedule) > 0): ?>
                                    ...
                                    <tr class="hover:bg-blue-50/30 transition-colors">
                                        <td class="px-8 py-6 font-bold text-[#0F172A]"><?php echo e($item['day'] ?? '-'); ?></td>
                                        <td class="px-8 py-6 text-gray-500"><?php echo e($item['start'] ?? ''); ?> - <?php echo e($item['end'] ?? ''); ?></td>
                                ...
                                <?php else: ?>
                                    <tr class="hover:bg-blue-50/30 transition-colors">
                                        ...
                                        <td class="px-8 py-6 text-gray-500"><?php echo e($eskul->schedule_info); ?></td>
                ...
                <div class="bg-white rounded-[2.5rem] border border-gray-100 p-8 space-y-6 shadow-sm">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center gap-6 group">
                            ...
                            <div class="space-y-1">
                                <p class="font-bold text-[#0F172A]">Pembina <?php echo e($eskul->name); ?></p>
