...
<?php $__env->startSection('title', 'Eskul Management - School Management System'); ?>

<?php $__env->startSection('content'); ?>
<div x-data="{ 
    searchQuery: '',
    currentFilter: 'Semua',
    eskuls: <?php echo e($extracurriculars->map(fn($e) => [
        'id' => $e->id,
        'name' => $e->name,
        'category' => $e->category,
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8 mt-8">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('superadmin.eskul.create')); ?>" class="flex items-center gap-2 px-6 py-2.5 bg-[#3B82F6] text-white rounded-xl text-sm font-semibold hover:bg-blue-700 shadow-sm transition-all focus:ring-4 focus:ring-blue-500/10">
                ...
                <tbody class="divide-y" :class="$store.theme.darkMode ? 'divide-gray-800' : 'divide-gray-50'">
                    <template x-for="e in filteredEskuls" :key="e.id">
                        <tr class="transition-all hover:bg-gray-50/50" :class="$store.theme.darkMode ? 'hover:bg-gray-800/30' : ''">
                            ...
                            <td class="px-6 py-5">
                                <button type="button" 
                                        @click="fetch(e.toggle_url, {method: 'POST', headers: {'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'}})
...
<?php echo $__env->make('layouts.superadmin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/superadmin/eskul/index.blade.php ENDPATH**/ ?>