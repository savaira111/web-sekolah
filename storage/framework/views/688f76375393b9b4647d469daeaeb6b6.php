<aside class="w-64 sidebar h-full flex flex-col transition-all duration-300 z-20 shrink-0 border-r border-gray-800" :class="{'hidden': !sidebarOpen}">
    ...
    <div class="flex-1 overflow-y-auto py-6 px-4 space-y-1">
        ...
        class="flex items-center gap-3 px-4 py-3 rounded-full font-medium text-sm transition-colors
        <?php echo e(request()->routeIs('superadmin.articles.*') ? 'sidebar-active shadow-lg shadow-blue-500/20' : 'sidebar-item'); ?>">


            <svg class="w-5 h-5 <?php echo e(request()->routeIs('superadmin.articles.*') ? 'text-white' : ''); ?>"
            fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div x-data="{ open: <?php echo e(request()->routeIs('superadmin.extracurricular-registrations.*') || request()->routeIs('superadmin.eskul.*') ? 'true' : 'false'); ?> }">
            ...
            <div x-show="open" 
                ...
                <a href="<?php echo e(route('superadmin.extracurricular-registrations.index')); ?>" 
                   class="block py-2 text-sm transition-colors <?php echo e(request()->routeIs('superadmin.extracurricular-registrations.index') ? 'text-blue-500 font-bold' : 'text-gray-500 hover:text-white'); ?>">
                    Pendaftaran
                </a>
            </div>
        </div>
