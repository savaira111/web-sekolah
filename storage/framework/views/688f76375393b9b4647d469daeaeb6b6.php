<aside class="w-64 sidebar h-full flex flex-col transition-all duration-300 z-20 shrink-0 border-r border-gray-800" :class="{'hidden': !sidebarOpen}">
    ...
    <div class="h-20 flex items-center px-6">
        <div class="w-10 h-10 bg-white rounded-lg flex items-center justify-center shrink-0 overflow-hidden border border-gray-700">
            <img src="<?php echo e(asset('images/logo-mahaputra.jpg')); ?>" alt="Logo" class="w-full h-full object-cover">
        </div>
    ...
    <div class="flex-1 overflow-y-auto py-6 px-4 space-y-1">
        ...
        <?php echo e(request()->routeIs('superadmin.dashboard') ? 'sidebar-active shadow-lg shadow-blue-500/20' : 'sidebar-item'); ?>">

            <svg class="w-5 h-5 <?php echo e(request()->routeIs('superadmin.dashboard') ? 'text-white' : ''); ?>"
            fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        class="flex items-center gap-3 px-4 py-3 rounded-full font-medium text-sm transition-colors
        <?php echo e(request()->routeIs('superadmin.albums.*') ? 'sidebar-active shadow-lg shadow-blue-500/20' : 'sidebar-item'); ?>">

            <svg class="w-5 h-5 <?php echo e(request()->routeIs('superadmin.albums.*') ? 'text-white' : ''); ?>"
            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
        ...
        class="flex items-center gap-3 px-4 py-3 rounded-full font-medium text-sm transition-colors
        <?php echo e(request()->routeIs('superadmin.landing-stats.*') ? 'sidebar-active shadow-lg shadow-blue-500/20' : 'sidebar-item'); ?>">

            <svg class="w-5 h-5 <?php echo e(request()->routeIs('superadmin.landing-stats.*') ? 'text-white' : ''); ?>"
            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
        ...
        class="flex items-center gap-3 px-4 py-3 rounded-full font-medium text-sm transition-colors
        <?php echo e(request()->routeIs('superadmin.partners.*') ? 'sidebar-active shadow-lg shadow-blue-500/20' : 'sidebar-item'); ?>">

            <svg class="w-5 h-5 <?php echo e(request()->routeIs('superadmin.partners.*') ? 'text-white' : ''); ?>"
            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
        ...
        class="flex items-center gap-3 px-4 py-3 rounded-full font-medium text-sm transition-colors
        <?php echo e(request()->routeIs('superadmin.users.*') ? 'sidebar-active shadow-lg shadow-blue-500/20' : 'sidebar-item'); ?>">

            <svg class="w-5 h-5 <?php echo e(request()->routeIs('superadmin.users.*') ? 'text-white' : ''); ?>"
            fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div x-data="{ open: <?php echo e(request()->routeIs('superadmin.articles.*') || request()->routeIs('superadmin.comments.*') ? 'true' : 'false'); ?> }">
            ...
            <?php echo e(request()->routeIs('superadmin.articles.*') || request()->routeIs('superadmin.comments.*') ? 'sidebar-active shadow-lg shadow-blue-500/20' : 'sidebar-item'); ?>">
                <div class="flex items-center gap-3">
                    <svg class="w-5 h-5 <?php echo e(request()->routeIs('superadmin.articles.*') || request()->routeIs('superadmin.comments.*') ? 'text-white' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div x-show="open" 
                ...
                <a href="/superadmin/articles" 
                   class="block py-2 text-sm transition-colors <?php echo e(request()->routeIs('superadmin.articles.*') ? 'text-blue-500 font-bold' : 'text-gray-500 hover:text-white'); ?>">
                    Berita Management
                </a>
                <a href="/superadmin/comments" 
                   class="flex items-center justify-between py-2 text-sm transition-colors <?php echo e(request()->routeIs('superadmin.comments.*') ? 'text-blue-500 font-bold' : 'text-gray-500 hover:text-white'); ?>">
                    <span>Manajemen Komentar</span>
                    <?php if($pendingCommentsCount > 0): ?>
                        <span class="px-2 py-0.5 bg-blue-500 text-white text-[10px] font-bold rounded-full mr-2"><?php echo e($pendingCommentsCount); ?></span>
                    <?php endif; ?>
                </a>
            </div>
        </div>
        ...
        class="flex items-center gap-3 px-4 py-3 rounded-full font-medium text-sm transition-colors
        <?php echo e(request()->routeIs('superadmin.messages.*') ? 'sidebar-active shadow-lg shadow-blue-500/20' : 'sidebar-item'); ?>">

            <svg class="w-5 h-5 <?php echo e(request()->routeIs('superadmin.messages.*') ? 'text-white' : ''); ?>"
            fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center justify-between flex-1 truncate">
                ...
                <?php if($unreadMessagesCount > 0): ?>
                    <span class="px-2 py-0.5 bg-amber-500 text-white text-[10px] font-bold rounded-full"><?php echo e($unreadMessagesCount); ?></span>
                <?php endif; ?>
            </div>
        </a>
        <?php endif; ?>
        ...
        <?php echo e(request()->routeIs('superadmin.ppdb.*') ? 'sidebar-active shadow-lg shadow-blue-500/20' : 'sidebar-item'); ?>">

            <svg class="w-5 h-5 <?php echo e(request()->routeIs('superadmin.ppdb.*') ? 'text-white' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center justify-between flex-1 truncate">
                ...
                <?php if($pendingPpdbCount > 0): ?>
                    <span class="px-2 py-0.5 bg-blue-500 text-white text-[10px] font-bold rounded-full"><?php echo e($pendingPpdbCount); ?></span>
                <?php endif; ?>
            </div>
        </a>
        <?php endif; ?>
        ...
        <div x-data="{ open: <?php echo e(request()->routeIs('superadmin.extracurricular-registrations.*') || request()->routeIs('superadmin.eskul.*') ? 'true' : 'false'); ?> }">
            <button @click="open = !open"
            class="flex items-center justify-between w-full px-4 py-3 rounded-full font-medium text-sm transition-colors
            <?php echo e(request()->routeIs('superadmin.extracurricular-registrations.*') || request()->routeIs('superadmin.eskul.*') ? 'sidebar-active shadow-lg shadow-blue-500/20' : 'sidebar-item'); ?>">
                <div class="flex items-center gap-3">
                    <svg class="w-5 h-5 <?php echo e(request()->routeIs('superadmin.extracurricular-registrations.*') || request()->routeIs('superadmin.eskul.*') ? 'text-white' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div x-show="open" 
                ...
                <a href="<?php echo e(route('superadmin.eskul.index')); ?>" 
                   class="block py-2 text-sm transition-colors <?php echo e(request()->routeIs('superadmin.eskul.index') ? 'text-blue-500 font-bold' : 'text-gray-500 hover:text-white'); ?>">
                    Manajemen Eskul
                </a>
                <a href="<?php echo e(route('superadmin.extracurricular-registrations.index')); ?>" 
                   class="flex items-center justify-between py-2 text-sm transition-colors <?php echo e(request()->routeIs('superadmin.extracurricular-registrations.index') ? 'text-blue-500 font-bold' : 'text-gray-500 hover:text-white'); ?>">
                    <span>Pendaftaran</span>
                    <?php if($pendingEskulCount > 0): ?>
                        <span class="px-2 py-0.5 bg-purple-500 text-white text-[10px] font-bold rounded-full mr-2"><?php echo e($pendingEskulCount); ?></span>
                    <?php endif; ?>
                </a>
            </div>
        </div>
