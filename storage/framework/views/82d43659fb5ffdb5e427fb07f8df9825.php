                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="space-y-3">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" placeholder="Nama Lengkap Anda" class="w-full pl-14 pr-8 py-4 bg-gray-50 rounded-2xl border-none focus:ring-2 focus:ring-blue-100 text-sm" value="<?php echo e(old('name')); ?>">
                            </div>
                        </div>
                        <div class="space-y-3">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" placeholder="contoh@email.com" class="w-full pl-14 pr-8 py-4 bg-gray-50 rounded-2xl border-none focus:ring-2 focus:ring-blue-100 text-sm" value="<?php echo e(old('email')); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="subject" placeholder="Tujuan pesan anda" class="w-full pl-14 pr-8 py-4 bg-gray-50 rounded-2xl border-none focus:ring-2 focus:ring-blue-100 text-sm" value="<?php echo e(old('subject')); ?>">
                        </div>
                    </div>
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="message" placeholder="Ceritakan bagaimana kami dapat membantu anda..." class="w-full pl-14 pr-8 py-6 h-48 bg-gray-50 rounded-3xl border-none focus:ring-2 focus:ring-blue-100 text-sm"><?php echo e(old('message')); ?></textarea>
                        </div>
                    </div>
