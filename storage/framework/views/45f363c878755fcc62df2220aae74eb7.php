        ...
        <div class="flex justify-between h-20">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <div class="relative group" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    <a href="<?php echo e(route('profile')); ?>" class="<?php echo e(request()->routeIs('profile') || request()->routeIs('staff') || request()->routeIs('seragam') ? 'text-blue-600 font-bold' : 'text-gray-600 hover:text-blue-600'); ?> font-medium transition-colors flex items-center gap-1 py-4">
                        Profil
