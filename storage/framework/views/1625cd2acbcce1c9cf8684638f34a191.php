<?php $__env->startSection('title', 'Detail ' . $applicant->full_name . ' - Manajemen PPDB'); ?>
...
<div class="px-8 pb-8 flex-1 w-full max-w-[1400px]">
    ...
    <div class="flex items-center gap-4 mt-8 mb-6">
        ...
        <div class="flex items-center gap-2 text-xs font-bold text-gray-400 uppercase tracking-widest">
            ...
            <span>Pendaftar</span>
            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>
            <span :class="$store.theme.darkMode ? 'text-blue-400' : 'text-blue-600'">Detail <?php echo e($applicant->full_name); ?></span>
        </div>
    </div>
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8 group">
        <div class="flex items-center gap-6">
            <div class="w-24 h-24 rounded-3xl overflow-hidden border-4 shadow-lg shrink-0 transition-all duration-300" :class="$store.theme.darkMode ? 'border-gray-800' : 'border-white'">
                <img src="<?php echo e($applicant->profile_image ? asset('storage/' . $applicant->profile_image) : 'https://ui-avatars.com/api/?name=' . urlencode($applicant->full_name) . '&background=0D8ABC&color=fff&size=128'); ?>" alt="Profile" class="w-full h-full object-cover">
            </div>
            <div>
                <div class="flex items-center gap-4 mb-1">
                    <h2 class="text-4xl font-extrabold tracking-tight transition-colors duration-300" :class="$store.theme.darkMode ? 'text-white' : 'text-gray-900'"><?php echo e($applicant->full_name); ?></h2>
                     <span class="px-4 py-1.5 rounded-full text-[11px] font-bold uppercase tracking-wider transition-colors duration-300" 
                          ...
                          ('<?php echo e($applicant->status); ?>' === 'Menunggu Review' ? 'bg-amber-500/10 text-amber-500 border border-amber-500/20' : 
                           ('<?php echo e($applicant->status); ?>' === 'Diterima' ? 'bg-emerald-500/10 text-emerald-500 border border-emerald-500/20' : 
                            ('<?php echo e($applicant->status); ?>' === 'Ditolak' ? 'bg-red-500/10 text-red-500 border border-red-500/20' : 'bg-gray-800 text-gray-400'))) : 
                          ('<?php echo e($applicant->status); ?>' === 'Menunggu Review' ? 'bg-amber-50 text-amber-600 border border-amber-100' : 
                           ('<?php echo e($applicant->status); ?>' === 'Diterima' ? 'bg-emerald-50 text-emerald-600 border border-emerald-100' : 
                            ('<?php echo e($applicant->status); ?>' === 'Ditolak' ? 'bg-red-50 text-red-600 border border-red-100' : 'bg-gray-50 text-gray-500')))">
        ...
        <div class="flex items-center gap-3">
            ...
            <?php if($applicant->status === 'Menunggu Review'): ?>
            <form action="<?php echo e(route('superadmin.ppdb.status', $applicant->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
            ...
            <?php if($applicant->status === 'Diterima'): ?>
            <a href="<?php echo e(route('superadmin.ppdb.download_pdf', $applicant->id)); ?>" class="flex items-center gap-2 px-8 py-3 bg-red-600 text-white font-bold rounded-2xl hover:bg-red-700 transition-all shadow-lg shadow-red-500/25">
            ...
            <div class="rounded-[2.5rem] p-10 border shadow-sm relative overflow-hidden transition-colors duration-300" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-800' : 'bg-white border-gray-100/50'">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
                    <div>
                        ...
                        <p class="text-[15px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->full_name); ?></p>
                    </div>
                    <div>
                        ...
                        <p class="text-[15px] font-bold transition-colors duration-300 text-blue-500 underline underline-offset-4" :class="$store.theme.darkMode ? 'text-blue-400' : 'text-blue-600'"><?php echo e($applicant->email ?? '-'); ?></p>
                    </div>
                    <div>
                        ...
                        <p class="text-[15px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->gender == 'Male' ? 'Laki-laki' : 'Perempuan'); ?></p>
                    </div>
                    <div>
                        ...
                        <p class="text-[15px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->birth_place); ?>, <?php echo e(\Carbon\Carbon::parse($applicant->birth_date)->format('d F Y')); ?></p>
                    </div>
                    <div>
                        ...
                        <p class="text-[15px] font-bold tracking-wider transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->nik); ?></p>
                    </div>
                    <div>
                        ...
                        <p class="text-[15px] font-bold tracking-wider transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->nisn); ?></p>
                    </div>
                    <div>
                        ...
                        <p class="text-[15px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->religion ?? '-'); ?></p>
                    </div>
                    <div>
                        ...
                        <p class="text-[15px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->citizenship); ?></p>
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center gap-3">
                            <span class="px-4 py-1.5 bg-blue-600 text-white rounded-xl text-xs font-black shadow-lg shadow-blue-500/20"><?php echo e($applicant->major ?? '-'); ?></span>
                            <span class="text-[11px] font-bold text-gray-400 italic">
                                <?php if($applicant->major == 'PPLG'): ?>
                                    Pengembangan Perangkat Lunak & Gim
                                <?php elseif($applicant->major == 'DKV'): ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="text-[15px] font-bold leading-relaxed transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->address); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-[2.5rem] p-10 border shadow-sm transition-colors duration-300" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-800' : 'bg-white border-gray-100/50'">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
                    <div>
                        ...
                        <p class="text-[15px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->school_origin ?? '-'); ?></p>
                    </div>
                    <div>
                        <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-1.5">Tahun Lulus</p>
                        <p class="text-[15px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->graduation_year ?? '-'); ?></p>
                    </div>
                    <div>
                        <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-1.5">Rata-rata Nilai</p>
                        <div class="flex items-center gap-3">
                            <span class="text-2xl font-black text-blue-600"><?php echo e($applicant->average_grade ?? '0.0'); ?></span>
                            <?php if(($applicant->average_grade ?? 0) >= 90): ?>
            ...
            <div class="rounded-[2.5rem] p-10 border shadow-sm transition-colors duration-300" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-800' : 'bg-white border-gray-100/50'">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-10 gap-x-12">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-[14px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->father_name); ?></p>
                            </div>
                            <div>
                                <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-1">Pekerjaan</p>
                                <p class="text-[14px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->father_job); ?></p>
                            </div>
                            <div>
                                <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-1">Nomor Telepon</p>
                                <p class="text-[14px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->father_phone); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-[14px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->mother_name); ?></p>
                            </div>
                            <div>
                                <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-1">Pekerjaan</p>
                                <p class="text-[14px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->mother_job); ?></p>
                            </div>
                            <div>
                                <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-1">Nomor Telepon</p>
                                <p class="text-[14px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->mother_phone); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2 pt-4 border-t transition-colors duration-300" :class="$store.theme.darkMode ? 'border-gray-800' : 'border-gray-50'">
                        ...
                        <p class="text-[14px] font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-gray-800'"><?php echo e($applicant->parent_income); ?></p>
                    </div>
                </div>
            </div>
                            ...
                            <div class="flex items-center gap-3 overflow-hidden">
                                <?php if($applicant->{$doc['field']}): ?>
                                    <input type="checkbox" class="doc-checkbox w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 transition-all cursor-pointer shrink-0" 
                                           data-url="<?php echo e(asset('storage/' . $applicant->{$doc['field']})); ?>" 
                                           data-filename="<?php echo e(str_replace(' ', '_', $doc['label'])); ?>_<?php echo e(str_replace(' ', '_', $applicant->full_name)); ?>.<?php echo e(pathinfo($applicant->{$doc['field']}, PATHINFO_EXTENSION)); ?>">
                                <?php endif; ?>
                                <div class="w-7 h-7 rounded-lg flex items-center justify-center shrink-0 <?php echo e($applicant->{$doc['field']} ? 'bg-emerald-100 text-emerald-600' : 'bg-gray-200 text-gray-400'); ?>">
                                    <?php if($applicant->{$doc['field']}): ?>
                                ...
                                <span class="text-[11px] font-bold transition-colors duration-300 truncate" :class="$store.theme.darkMode ? 'text-gray-300' : 'text-gray-700'"><?php echo e($doc['label']); ?></span>
                            </div>
                            <?php if($applicant->{$doc['field']}): ?>
                                <div class="flex items-center gap-2 shrink-0">
                                    ...
                                    ?>
                                    <button type="button" @click.prevent="docUrl = '<?php echo e(asset('storage/' . $applicant->{$doc['field']})); ?>'; isDocPdf = <?php echo e($isPdf ? 'true' : 'false'); ?>; showDocModal = true" 
                                     ...
                                     <a href="<?php echo e(asset('storage/' . $applicant->{$doc['field']})); ?>" 
                                       download="<?php echo e(str_replace(' ', '_', $doc['label'])); ?>_<?php echo e(str_replace(' ', '_', $applicant->full_name)); ?>.<?php echo e(pathinfo($applicant->{$doc['field']}, PATHINFO_EXTENSION)); ?>"
...
<?php echo $__env->make('layouts.superadmin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/superadmin/ppdb/show.blade.php ENDPATH**/ ?>