<?php $__env->startSection('title', 'Edit Statistik - Admin Mahput'); ?>
...
<div class="px-8 pb-8 flex-1 w-full" :class="$store.theme.darkMode ? '' : 'bg-[#F3F4F6]'">
    ...
    <nav class="flex mb-6 text-sm" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2">
            ...
            <li class="flex items-center space-x-2">
                ...
                <a href="<?php echo e(route('superadmin.landing-stats.index')); ?>" class="text-gray-500 hover:text-blue-600">Statistik Landing Page</a>
            </li>
    ...
    <form action="<?php echo e(route('superadmin.landing-stats.update', $landing_stat->id)); ?>" method="POST" class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <?php echo csrf_field(); ?>
            ...
            <div class="rounded-3xl p-8 shadow-xl transition-all duration-200" :class="$store.theme.darkMode ? 'bg-[#111827]/50' : 'bg-white'">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="group">
                        ...
                        <input type="text" name="title" id="title" required value="<?php echo e(old('title', $landing_stat->title)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="group">
                        ...
                        <input type="text" name="value" id="value" required value="<?php echo e(old('value', $landing_stat->value)); ?>"
                               class="w-full px-5 py-3 rounded-xl border transition-all duration-200"
                               :class="$store.theme.darkMode ? 'bg-[#111827]/50 border-gray-800 text-white focus:border-blue-500/50' : 'bg-gray-50 border-gray-200 focus:border-blue-400/50'"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6 group">
                    ...
                    <textarea name="icon" id="icon" rows="3"
                           ...
                           :class="$store.theme.darkMode ? 'bg-[#111827]/50 border-gray-800 text-white focus:border-blue-500/50' : 'bg-gray-50 border-gray-200 focus:border-blue-400/50'"
                           placeholder="Masukkan path data SVG dari Heroicons (d attribute)"><?php echo e(old('icon', $landing_stat->icon)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="group">
                        ...
                        <input type="number" name="order" id="order" value="<?php echo e(old('order', $landing_stat->order)); ?>"
                               class="w-full px-5 py-3 rounded-xl border transition-all duration-200"
                               :class="$store.theme.darkMode ? 'bg-[#111827]/50 border-gray-800 text-white focus:border-blue-500/50' : 'bg-gray-50 border-gray-200 focus:border-blue-400/50'">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="group">
                        ...
                        <select name="color" id="color" required
                                ...
                                :class="$store.theme.darkMode ? 'bg-[#111827]/50 border-gray-800 text-white focus:border-blue-500/50' : 'bg-gray-50 border-gray-200 focus:border-blue-400/50'">
                            <option value="blue" <?php echo e(old('color', $landing_stat->color) == 'blue' ? 'selected' : ''); ?>>Blue</option>
                            <option value="indigo" <?php echo e(old('color', $landing_stat->color) == 'indigo' ? 'selected' : ''); ?>>Indigo</option>
                            <option value="orange" <?php echo e(old('color', $landing_stat->color) == 'orange' ? 'selected' : ''); ?>>Orange</option>
                            <option value="emerald" <?php echo e(old('color', $landing_stat->color) == 'emerald' ? 'selected' : ''); ?>>Emerald</option>
                            <option value="rose" <?php echo e(old('color', $landing_stat->color) == 'rose' ? 'selected' : ''); ?>>Rose</option>
                            <option value="purple" <?php echo e(old('color', $landing_stat->color) == 'purple' ? 'selected' : ''); ?>>Purple</option>
                            <option value="amber" <?php echo e(old('color', $landing_stat->color) == 'amber' ? 'selected' : ''); ?>>Amber</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6 mb-8">
                    <div class="flex items-center justify-between">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="is_active" value="1" <?php echo e($landing_stat->is_active ? 'checked' : ''); ?> class="sr-only peer">
...
<?php echo $__env->make('layouts.superadmin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/superadmin/landing-stats/edit.blade.php ENDPATH**/ ?>