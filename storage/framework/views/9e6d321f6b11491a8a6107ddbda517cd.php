        ...
        <div class="bg-white rounded-[1.5rem] shadow-2xl overflow-hidden relative">
            ...
            <div class="p-6 pt-0 space-y-4 text-center">
                ...
                <div class="space-y-4 pt-4">
                    <button onclick="window.location.href='<?php echo e(route('home')); ?>'" class="w-full py-5 bg-blue-50 text-blue-600 rounded-[1.5rem] font-black text-lg hover:bg-blue-100 transition-all uppercase">
                        Kembali ke Beranda
                    </button>
                    <button onclick="window.location.href='<?php echo e(route('extracurriculars.index')); ?>'" class="w-full py-5 bg-gray-50 text-[#0F172A] rounded-[1.5rem] font-black text-lg hover:bg-gray-100 transition-all uppercase">
                        Tutup
                    </button>
                </div>
            </div>
