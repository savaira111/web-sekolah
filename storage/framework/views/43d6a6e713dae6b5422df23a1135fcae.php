<?php $__env->startSection('title', 'Tambah Statistik - Admin Mahput'); ?>
...
<div class="px-8 pb-8 flex-1 w-full" :class="$store.theme.darkMode ? '' : 'bg-[#F3F4F6]'">
    ...
    <form action="<?php echo e(route('superadmin.landing-stats.store')); ?>" method="POST" class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="group">
                        ...
                        <input type="text" name="value" id="value" required value="<?php echo e(old('value')); ?>"
                               class="w-full px-5 py-3 rounded-xl border transition-all duration-200"
                               :class="$store.theme.darkMode ? 'bg-[#111827]/50 border-gray-800 text-white focus:border-blue-500/50' : 'bg-gray-50 border-gray-200 focus:border-blue-400/50'"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6 group">
                    ...
                    <textarea name="icon" id="icon" rows="3"
                           ...
                           :class="$store.theme.darkMode ? 'bg-[#111827]/50 border-gray-800 text-white focus:border-blue-500/50' : 'bg-gray-50 border-gray-200 focus:border-blue-400/50'"
                           placeholder="Masukkan path data SVG dari Heroicons (d attribute)"><?php echo e(old('icon')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="group">
                        ...
                        <select name="color" id="color" required
                            ...
                            <option value="indigo" <?php echo e(old('color') == 'indigo' ? 'selected' : ''); ?>>Indigo</option>
                            <option value="orange" <?php echo e(old('color') == 'orange' ? 'selected' : ''); ?>>Orange</option>
                            <option value="emerald" <?php echo e(old('color') == 'emerald' ? 'selected' : ''); ?>>Emerald</option>
                            <option value="rose" <?php echo e(old('color') == 'rose' ? 'selected' : ''); ?>>Rose</option>
                            <option value="purple" <?php echo e(old('color') == 'purple' ? 'selected' : ''); ?>>Purple</option>
                            <option value="amber" <?php echo e(old('color') == 'amber' ? 'selected' : ''); ?>>Amber</option>
                        </select>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.superadmin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/superadmin/landing-stats/create.blade.php ENDPATH**/ ?>