...
<div id="chatbot-wrapper" class="fixed bottom-6 right-6 z-[9999] flex flex-col items-end pointer-events-none">
            ...
            <div class="flex items-center gap-4">
                <div class="relative">
                    <div class="w-12 h-12 rounded-full overflow-hidden border-2 border-white/50 bg-white">
                        <img src="<?php echo e(asset('images/chatbot-mascot.png')); ?>" alt="Mascot" class="w-full h-full object-cover">
                    </div>
            ...
            <div class="flex justify-start animate-in fade-in slide-in-from-bottom-2 duration-400 font-sans">
                <div class="flex items-start gap-3 w-full">
                    <div class="w-9 h-9 rounded-full bg-blue-50 flex items-center justify-center shrink-0 border border-blue-100 shadow-sm overflow-hidden">
                        <img src="<?php echo e(asset('images/chatbot-mascot.png')); ?>" alt="MCU" class="w-full h-full rounded-full object-cover">
                    </div>
    ...
    <button id="chatbot-toggle" class="bg-[#1e88e5] w-16 h-16 rounded-full shadow-[0_10px_25px_rgba(30,136,229,0.4)] flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 pointer-events-auto cursor-pointer border-4 border-white overflow-hidden p-0">
        <div id="btn-icon" class="w-full h-full flex items-center justify-center transition-transform duration-300">
            <img src="<?php echo e(asset('images/chatbot-mascot.png')); ?>" alt="MCU Mascot" class="w-full h-full object-cover">
        </div>
    </button>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggleChat() {
        ...
        if (isOpen) {
            ...
            btnIcon.innerHTML = `<img src="<?php echo e(asset('images/chatbot-mascot.png')); ?>" alt="MCU Mascot" class="w-full h-full object-cover">`;
    ...
    function addMessage(text, isUser = false) {
        ...
        ` : `
            <div class="flex items-start gap-3 w-full">
                <div class="w-9 h-9 rounded-full bg-blue-50 flex items-center justify-center shrink-0 border border-blue-100 shadow-sm overflow-hidden">
                    <img src="<?php echo e(asset('images/chatbot-mascot.png')); ?>" class="w-full h-full object-cover">
                </div>
                <div class="bg-gradient-to-br from-[#1e88e5] to-[#1565c0] text-white p-4 rounded-3xl rounded-tl-none shadow-lg shadow-blue-100/50 max-w-[85%] break-words">
                    <p class="text-sm leading-relaxed">${content}</p>
                </div>
    ...
    function handleUserInput(text) {
        ...
        thinkingDiv.innerHTML = `
            <div class="w-9 h-9 rounded-full bg-blue-50 border border-blue-100 overflow-hidden shrink-0"><img src="<?php echo e(asset('images/chatbot-mascot.png')); ?>" class="w-full h-full object-cover"></div>
...
<?php /**PATH C:\laragon\www\web-sekolah\resources\views/layouts/chatbot.blade.php ENDPATH**/ ?>