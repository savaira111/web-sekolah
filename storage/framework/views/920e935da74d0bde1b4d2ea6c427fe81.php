<?php $__env->startSection('title', 'Mitra Industri - SMKS Mahaputra Cerdas Utama'); ?>
            ...
            <div class="relative">
                ...
                <div class="relative z-10">
                    <div class="aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-2xl border-[12px] border-white ring-1 ring-gray-100">
                        <img src="<?php echo e(asset('images/mitra-hero.png')); ?>" alt="Sinergi Industri" class="w-full h-full object-cover">
                        <!-- Glass Overlay -->
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6 bg-white p-4 rounded-3xl shadow-sm border border-gray-100">
            <div class="flex flex-wrap items-center gap-2">
                ...
                <a href="<?php echo e(route('mitra', ['category' => $cat])); ?>" 
                   class="px-6 py-3 rounded-full text-sm font-extrabold transition-all <?php echo e(($request->category ?? '') === $cat ? 'bg-[#1E3A8A] text-white shadow-lg' : 'text-gray-500 hover:bg-gray-100'); ?>">
                   <?php echo e($cat); ?>
            ...
            <div class="text-sm font-bold text-gray-400 px-4">
                Menampilkan <span class="text-gray-900"><?php echo e($partners->count()); ?></span> Perusahaan
            </div>
        </div>
            ...
            <a href="<?php echo e(route('mitra.show', $partner->id)); ?>" class="group bg-white rounded-[2rem] p-8 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border border-gray-50 flex flex-col h-full">
                ...
                <div class="flex items-start justify-between mb-8">
                    <div class="w-16 h-16 rounded-2xl bg-gray-50 p-3 border border-gray-100 flex items-center justify-center overflow-hidden shrink-0">
                        <?php if($partner->logo): ?>
                        <img src="<?php echo e(asset('storage/' . $partner->logo)); ?>" alt="<?php echo e($partner->name); ?>" class="w-full h-full object-contain group-hover:scale-110 transition-transform duration-500">
                        <?php else: ?>
                    ...
                    ?>
                    <span class="px-3 py-1 rounded-lg text-[9px] font-black tracking-widest uppercase <?php echo e($badgeColorClasses[$badgeIdx % 4]); ?>">
                        <?php echo e($badge); ?>
                ...
                <!-- Card Content -->
                <div class="flex-1">
                    <h3 class="text-xl font-black text-[#0F172A] mb-2 group-hover:text-blue-600 transition-colors leading-tight"><?php echo e($partner->name); ?></h3>
                    <p class="text-[13px] text-gray-400 font-bold leading-relaxed mb-6">
                        <?php echo e($partner->category); ?> &bull; <?php echo e(Str::limit($partner->description, 60)); ?>
        ...
        <div class="relative bg-gradient-to-br from-[#0256B3] to-[#014188] rounded-[3rem] p-12 lg:p-20 overflow-hidden shadow-2xl text-center">
            ...
            <div class="relative z-10 max-w-3xl mx-auto space-y-8">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
                    <a href="<?php echo e(route('contact')); ?>" class="w-full sm:w-auto px-10 py-5 bg-white text-blue-700 rounded-2xl font-black text-base shadow-xl shadow-blue-900/20 hover:bg-blue-50 transition-all active:scale-95 uppercase tracking-wide">
                        Mulai Kemitraan
                    </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/mitra.blade.php ENDPATH**/ ?>