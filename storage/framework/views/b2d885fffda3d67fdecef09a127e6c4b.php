<?php $__env->startSection('title', 'Statistik Landing Page - Admin Mahput'); ?>
...
<div class="px-8 pb-8 flex-1 w-full overflow-x-auto" x-data="{ isDeleteModalOpen: false, statToDelete: null }">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8 mt-2">
        ...
        <div class="flex items-center gap-4">
            <a href="<?php echo e(route('superadmin.landing-stats.create')); ?>" class="px-6 py-2.5 bg-[#3B82F6] hover:bg-[#2563EB] text-white text-sm font-bold rounded-full transition-all duration-300 shadow-lg shadow-blue-500/30 flex items-center justify-center gap-2">
            ...
            <table class="w-full text-left border-collapse min-w-[800px]">
                ...
                <tbody class="text-[14px]">
                    ...
                    <tr class="border-b last:border-0 transition-colors group" :class="$store.theme.darkMode ? 'border-gray-800 hover:bg-black/20/50' : 'border-gray-50 hover:bg-gray-50/50'">
                        <td class="py-5 pl-2">
                            <span class="font-bold" :class="$store.theme.darkMode ? 'text-white' : 'text-[#111827]'"><?php echo e($stat->order); ?></span>
                        </td>
                        <td class="py-5">
                            <div class="w-10 h-10 rounded-xl flex items-center justify-center transition-colors duration-300" 
                                 :class="$store.theme.darkMode ? 'bg-<?php echo e($stat->color); ?>-500/20 text-<?php echo e($stat->color); ?>-400' : 'bg-<?php echo e($stat->color); ?>-50 text-<?php echo e($stat->color); ?>-600'">
                                <?php if($stat->icon): ?>
                        ...
                        <td class="py-5">
                            <span class="font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-white' : 'text-[#111827]'"><?php echo e($stat->title); ?></span>
                        </td>
                        <td class="py-5">
                            <span class="font-black text-lg transition-colors duration-300" :class="$store.theme.darkMode ? 'text-blue-400' : 'text-blue-600'"><?php echo e($stat->value); ?></span>
                        </td>
                        <td class="py-5 text-center">
                            <span class="inline-block px-3 py-1 font-black text-[10px] rounded-full uppercase tracking-widest transition-colors duration-300" 
                                  :class="$store.theme.darkMode ? 'bg-<?php echo e($stat->color); ?>-500/10 text-<?php echo e($stat->color); ?>-400' : 'bg-<?php echo e($stat->color); ?>-50 text-<?php echo e($stat->color); ?>-600'">
                        ...
                        <td class="py-5 text-right pr-2">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo e(route('superadmin.landing-stats.edit', $stat->id)); ?>" class="w-8 h-8 rounded-full border flex items-center justify-center transition-colors" :class="$store.theme.darkMode ? 'border-gray-700 text-blue-400 hover:bg-gray-800' : 'border-gray-200 text-blue-600 hover:bg-blue-50'">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                </a>

                                <button @click="isDeleteModalOpen = true; statToDelete = <?php echo e($stat->id); ?>" class="w-8 h-8 rounded-full border flex items-center justify-center transition-colors" :class="$store.theme.darkMode ? 'border-gray-700 text-red-400 hover:bg-gray-800' : 'border-gray-200 text-red-500 hover:bg-red-50'">
...
<?php echo $__env->make('layouts.superadmin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-sekolah\resources\views/superadmin/landing-stats/index.blade.php ENDPATH**/ ?>