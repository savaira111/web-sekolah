    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="rounded-[20px] p-6 shadow-sm border transition-all flex flex-col justify-between h-[150px]" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-800' : 'bg-white border-gray-100'">
            ...
            <div>
                ...
                <h3 class="text-[28px] font-extrabold leading-none transition-colors" :class="$store.theme.darkMode ? 'text-white' : 'text-[#0F172A]'">{{ $totalPendaftar }}</h3>
            </div>
        </div>
        ...
        <div class="rounded-[20px] p-6 shadow-sm border transition-all flex flex-col justify-between h-[150px]" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-800' : 'bg-white border-gray-100'">
            ...
            <div>
                ...
                <h3 class="text-[28px] font-extrabold leading-none transition-colors" :class="$store.theme.darkMode ? 'text-white' : 'text-[#0F172A]'">{{ $pendaftarBaru }}</h3>
            </div>
        </div>
        ...
        <div class="rounded-[20px] p-6 shadow-sm border transition-all flex flex-col justify-between h-[150px]" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-800' : 'bg-white border-gray-100'">
            ...
            <div>
                ...
                <h3 class="text-[25px] font-extrabold leading-none truncate transition-colors" :class="$store.theme.darkMode ? 'text-white' : 'text-[#0F172A]'" title="{{ $popular }}">{{ $popular }}</h3>
            </div>
        </div>
                        ...
                        <tr class="border-b transition-colors group" :class="$store.theme.darkMode ? 'border-gray-800/50 hover:bg-black/40' : 'border-gray-50 hover:bg-gray-50/50'">
                            <td class="py-4 px-6">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="font-bold text-sm transition-colors" :class="$store.theme.darkMode ? 'text-gray-200' : 'text-[#0F172A]'">{{ $reg->name }}</div>
                                </div>
                            </td>
                            ...
                            <td class="py-4 px-6 text-right">
                                <div class="flex items-center justify-end gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                    ...
                                    @elseif($reg->status === 'approved')
                                        <a href="{{ route('superadmin.extracurricular-registrations.download', $reg->id) }}" class="text-gray-400 hover:text-blue-500 transition-colors" title="Unduh PDF">
