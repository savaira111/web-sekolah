...
<div class="px-8 pb-8 flex-1 w-full max-w-[1400px]">
    ...
    <div class="flex items-center gap-4 mt-8 mb-6">
        <a href="{{ route('superadmin.ppdb.index') }}" 
           ...
           :class="darkMode ? 'bg-gray-800 border-gray-700 text-gray-400 hover:bg-gray-700 hover:text-white' : 'bg-white border-gray-100 text-gray-400 hover:bg-gray-50 hover:text-gray-600'"
        ...
        <div class="flex items-center gap-2 text-xs font-bold text-gray-400 uppercase tracking-widest">
            ...
            <span>Pendaftar</span>
            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>
            <span :class="darkMode ? 'text-blue-400' : 'text-blue-600'">Detail {{ $applicant->full_name }}</span>
        </div>
    </div>
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8 group">
        <div class="flex items-center gap-6">
            <div class="w-24 h-24 rounded-3xl overflow-hidden border-4 shadow-lg shrink-0 transition-all duration-300" :class="darkMode ? 'border-gray-800' : 'border-white'">
            ...
            <div>
                <div class="flex items-center gap-4 mb-1">
                    <h2 class="text-4xl font-extrabold tracking-tight transition-colors duration-300" :class="darkMode ? 'text-white' : 'text-gray-900'">{{ $applicant->full_name }}</h2>
                ...
                <div class="flex items-center gap-3 text-sm font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-500' : 'text-gray-400'">
                    <span class="px-2 py-0.5 rounded text-[11px] uppercase transition-colors duration-300" :class="darkMode ? 'bg-gray-800 text-gray-400' : 'bg-gray-100 text-gray-500'">{{ $applicant->registration_number }}</span>
                    <span class="w-1 h-1 rounded-full transition-colors duration-300" :class="darkMode ? 'bg-gray-700' : 'bg-gray-300'"></span>
        ...
        <div class="flex items-center gap-3">
            <button class="flex items-center gap-2 px-6 py-3 border font-bold rounded-2xl transition-all shadow-sm" :class="darkMode ? 'bg-gray-800 border-gray-700 text-gray-300 hover:bg-gray-700' : 'bg-white border-gray-200 text-gray-700 hover:bg-gray-50'">
            ...
            <form action="{{ route('superadmin.ppdb.status', $applicant->id) }}" method="POST">
                ...
                <button type="submit" class="flex items-center gap-2 px-6 py-3 border font-bold rounded-2xl transition-all" :class="darkMode ? 'bg-red-500/10 border-red-500/20 text-red-500 hover:bg-red-500/20' : 'bg-red-50 border-red-100 text-red-600 hover:bg-red-100'">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <!-- Personal Biodata -->
            <!-- Personal Biodata -->
            <div class="rounded-[2.5rem] p-10 border shadow-sm relative overflow-hidden transition-colors duration-300" :class="darkMode ? 'bg-[#1E293B] border-gray-800' : 'bg-white border-gray-100/50'">
                <div class="flex items-center justify-between mb-10">
                    <div class="flex items-center gap-3">
                        <div class="p-2.5 bg-blue-50 text-blue-600 rounded-xl">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                        </div>
                        <h3 class="text-xl font-extrabold transition-colors duration-300" :class="darkMode ? 'text-white' : 'text-gray-900'">Biodata Pribadi</h3>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
                    <div>
                        <p class="text-[10px] font-extrabold uppercase tracking-widest mb-1.5 transition-colors duration-300" :class="darkMode ? 'text-gray-500' : 'text-gray-400'">Nama Lengkap</p>
                        <p class="text-[15px] font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->full_name }}</p>
                    </div>
                    <div>
                        <p class="text-[10px] font-extrabold uppercase tracking-widest mb-1.5 transition-colors duration-300" :class="darkMode ? 'text-gray-500' : 'text-gray-400'">Jenis Kelamin</p>
                        <p class="text-[15px] font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->gender == 'Male' ? 'Laki-laki' : 'Perempuan' }}</p>
                    </div>
                    <div>
                        <p class="text-[10px] font-extrabold uppercase tracking-widest mb-1.5 transition-colors duration-300" :class="darkMode ? 'text-gray-500' : 'text-gray-400'">Tempat, Tanggal Lahir</p>
                        <p class="text-[15px] font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->birth_place }}, {{ \Carbon\Carbon::parse($applicant->birth_date)->format('d F Y') }}</p>
                    </div>
                    <div>
                        <p class="text-[10px] font-extrabold uppercase tracking-widest mb-1.5 transition-colors duration-300" :class="darkMode ? 'text-gray-500' : 'text-gray-400'">NISN</p>
                        <p class="text-[15px] font-bold tracking-wider transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->nisn }}</p>
                    </div>
                    <div>
                        <p class="text-[10px] font-extrabold uppercase tracking-widest mb-1.5 transition-colors duration-300" :class="darkMode ? 'text-gray-500' : 'text-gray-400'">Agama</p>
                        <p class="text-[15px] font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->religion ?? '-' }}</p>
                    </div>
                    <div>
                        <p class="text-[10px] font-extrabold uppercase tracking-widest mb-1.5 transition-colors duration-300" :class="darkMode ? 'text-gray-500' : 'text-gray-400'">Kewarganegaraan</p>
            ...
            <div class="rounded-[2.5rem] p-10 border shadow-sm transition-colors duration-300" :class="darkMode ? 'bg-[#1E293B] border-gray-800' : 'bg-white border-gray-100/50'">
                <div class="flex items-center gap-3 mb-10">
                    ...
                    <h3 class="text-xl font-extrabold transition-colors duration-300" :class="darkMode ? 'text-white' : 'text-gray-900'">Sekolah Asal & Akademik</h3>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
                    <div>
                        <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-1.5">Sekolah Sebelumnya</p>
                        <p class="text-[15px] font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->school_origin ?? '-' }}</p>
                    </div>
                    <div>
                        <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-1.5">Tahun Lulus</p>
                        <p class="text-[15px] font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->graduation_year ?? '-' }}</p>
                    </div>
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            @if(($applicant->average_grade ?? 0) >= 90)
                                <span class="px-2.5 py-1 rounded text-[9px] font-bold uppercase tracking-widest transition-colors duration-300" :class="darkMode ? 'bg-emerald-500/10 text-emerald-400' : 'bg-emerald-50 text-emerald-600'">Sangat Baik</span>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="rounded-[2.5rem] p-10 border shadow-sm transition-colors duration-300" :class="darkMode ? 'bg-[#1E293B] border-gray-800' : 'bg-white border-gray-100/50'">
                <div class="flex items-center gap-3 mb-10">
                    ...
                    <h3 class="text-xl font-extrabold transition-colors duration-300" :class="darkMode ? 'text-white' : 'text-gray-900'">Informasi Orang Tua</h3>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-[14px] font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->father_name }}</p>
                            </div>
                            <div>
                                <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-1">Pekerjaan</p>
                                <p class="text-[14px] font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->father_job }}</p>
                            </div>
                            <div>
                                <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-1">Nomor Telepon</p>
                                <p class="text-[14px] font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->father_phone }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-[14px] font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->mother_name }}</p>
                            </div>
                            <div>
                                <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-1">Pekerjaan</p>
                                <p class="text-[14px] font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->mother_job }}</p>
                            </div>
                            <div>
                                <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-1">Nomor Telepon</p>
                                <p class="text-[14px] font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->mother_phone }}</p>
                            </div>
                        </div>
                    </div>

                    <div class="md:col-span-2 pt-4 border-t transition-colors duration-300" :class="darkMode ? 'border-gray-800' : 'border-gray-50'">
                        <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-1">Penghasilan Gabungan</p>
                        <p class="text-[14px] font-bold transition-colors duration-300" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">{{ $applicant->parent_income }}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-8">
            ...
            <!-- Documents -->
            <!-- Documents -->
            <div class="rounded-[2.5rem] p-8 border shadow-sm transition-colors duration-300" :class="darkMode ? 'bg-[#1E293B] border-gray-800' : 'bg-white border-gray-100/50'">
                <div class="flex items-center justify-between mb-8">
                    <div class="flex items-center gap-3">
                        <div class="p-2 bg-indigo-50 text-indigo-600 rounded-xl">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                        </div>
                        <h3 class="font-extrabold transition-colors duration-300" :class="darkMode ? 'text-white' : 'text-gray-900'">Dokumen</h3>
                    </div>
                </div>
            ...
            <!-- Residence Location -->
            <!-- Residence Location -->
            <div class="rounded-[2.5rem] p-8 border shadow-sm relative overflow-hidden transition-colors duration-300" :class="darkMode ? 'bg-[#1E293B] border-gray-800' : 'bg-white border-gray-100/50'">
                <div class="flex items-center gap-3 mb-6">
                    <div class="p-2 bg-rose-50 text-rose-600 rounded-xl">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    </div>
                    <h3 class="font-extrabold transition-colors duration-300" :class="darkMode ? 'text-white' : 'text-gray-900'">Lokasi Tempat Tinggal</h3>
                </div>
                ...
                <div class="mt-4 flex items-center justify-between">
                    <p class="text-[11px] font-bold uppercase tracking-widest leading-none transition-colors duration-300" :class="darkMode ? 'text-gray-500' : 'text-gray-400'">Koordinat: -6.2234, 106.8123</p>
