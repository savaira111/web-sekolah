                ...
                <div class="rounded-xl shadow-sm border p-6 hover:shadow-md transition-shadow transition-colors duration-300" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-700' : 'bg-white border-gray-200'">
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-white' : 'text-gray-900'">{{ $messages->total() ?? '1,284' }}</h3>
                ...
                <div class="rounded-xl shadow-sm border p-6 hover:shadow-md transition-shadow transition-colors duration-300" :class="$store.theme.darkMode ? 'bg-[#111827] border-gray-700' : 'bg-white border-gray-200'">
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-white' : 'text-gray-900'">{{ $messages->count() ?? '42' }}</h3>
                            ...
                            <tr class="transition-colors duration-300" :class="$store.theme.darkMode ? 'hover:bg-black/20' : 'hover:bg-gray-50'">
                                <td class="px-8 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-bold transition-colors duration-300" :class="$store.theme.darkMode ? 'text-white' : 'text-gray-900'">{{ substr($msg->name, 0, 20) }}</p>
                                            <p class="text-xs mt-0.5 transition-colors duration-300" :class="$store.theme.darkMode ? 'text-gray-400' : 'text-gray-500'">{{ $msg->created_at->diffForHumans() }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-8 py-4">
