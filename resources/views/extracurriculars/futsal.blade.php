...
@section('title', 'Futsal - SMKS Mahaputra')
        ...
        <div class="space-y-6 max-w-4xl">
            ...
            <div class="flex items-center gap-6">
                ...
                <h1 class="text-5xl lg:text-7xl font-black text-white leading-tight">
                    Klub <span class="text-blue-500">Futsal</span>
                </h1>
            </div>
            <p class="text-xl text-gray-300 max-w-3xl leading-relaxed font-medium">
                Kerjasama tim dan ketangkasan fisik melalui latihan rutin dan kompetisi antar sekolah.
            </p>
        </div>
                ...
                <div class="space-y-12">
                    <div class="space-y-6">
                        <div class="flex items-center gap-4">
                            ...
                            <h2 class="text-3xl font-black text-[#0F172A]">Tentang Futsal</h2>
                        </div>
                        <p class="text-base text-gray-500 leading-relaxed">
                            Futsal SMKS Mahaputra Cerdas Utama merupakan wadah pembinaan generasi muda untuk mengembangkan potensi, bakat, dan semangat positif. Anggota dilatih untuk memiliki karakter unggul, kedisiplinan, dan etika yang baik serta berprestasi dalam berbagai kegiatan.
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-2xl font-black text-[#0F172A] tracking-tight">20+ Trophy</p>
                            </div>
                        </div>
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            <div class="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center text-blue-600">
                 ...
                 <div class="space-y-12">
                    ...
                    <div class="space-y-8">
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-lg font-bold text-[#0F172A]">Minat & Bakat</h4>
                                <p class="text-sm text-gray-500">Memiliki ketertarikan pada olahraga futsal dan komitmen untuk berlatih secara rutin.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-lg font-bold text-[#0F172A]">Kesehatan Tubuh</h4>
                                <p class="text-sm text-gray-500">Sehat secara jasmani dan rohani, serta tidak memiliki riwayat cedera berat yang mengganggu aktivitas olahraga.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                <tr class="hover:bg-blue-50/30 transition-colors">
                                    ...
                                    <td class="px-8 py-6 text-gray-500">16:00 - 18:00</td>
                                    <td class="px-8 py-6 text-gray-500 font-bold">Fisik & Taktik</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="group space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <h3 class="text-lg font-bold text-[#0F172A] group-hover:text-blue-600 transition-colors leading-snug">Prestasi Gemilang Futsal Tingkat Provinsi</h3>
                        ...
                        <div class="group space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <h3 class="text-xl font-bold text-[#0F172A] group-hover:text-blue-600 transition-colors leading-snug">Agenda Tahunan & Pelatihan Anggota Baru Futsal</h3>
                                <div class="flex items-center gap-3 pt-2">
                                    <div class="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center">
                                        <svg class="w-4 h-4 text-blue-600" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08s5.97 1.09 6 3.08c-1.29 1.94-3.5 3.22-6 3.22z"/></svg>
                                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center gap-6 group">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Ketua Futsal</p>
                            </div>
                        </div>
                    </div>
                </div>
