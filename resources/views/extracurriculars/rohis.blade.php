...
@section('title', 'Rohis - SMKS Mahaputra')
...
<section class="relative min-h-screen flex items-start pt-16 lg:pt-20 overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img src="{{ asset('images/extracurriculars/thumbs/rohis.png') }}" alt="Hero" class="w-full h-full object-cover">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div class="space-y-6 max-w-4xl">
            ...
            <div class="flex flex-wrap gap-4 pt-10">
                ...
                <a href="https://wa.me/6282260337300?text=Halo%20Admin%2C%20saya%20ingin%20tanya%20seputar%20ekstrakurikuler%20Rohis" target="_blank" class="px-10 py-5 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-2xl font-black text-xl hover:bg-white/20 transition-all uppercase flex items-center gap-3">
                ...
                <div class="space-y-12">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                        <div class="aspect-square rounded-[1.5rem] overflow-hidden group cursor-pointer border border-gray-100 shadow-sm relative">
                            <img src="{{ asset('images/extracurriculars/thumbs/rohis.png') }}" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110">
                        ...
                        <div class="aspect-square rounded-[1.5rem] overflow-hidden group cursor-pointer border border-gray-100 shadow-sm relative">
                            <img src="https://images.unsplash.com/photo-1542810634-71277d95dcbb?q=80&w=800" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110">
                            <div class="absolute inset-0 bg-blue-600/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                            </div>
                        </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="group space-y-4">
                            <div class="aspect-[4/3] rounded-[2rem] overflow-hidden shadow-lg border border-gray-100">
                                <img src="{{ asset('images/extracurriculars/thumbs/rohis.png') }}" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="space-y-2">
                        ...
                        <div class="group space-y-4">
                            <div class="aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-lg border border-gray-100">
                                <img src="https://images.unsplash.com/photo-1542810634-71277d95dcbb?q=80&w=800" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="space-y-2">
                                <div class="flex items-center gap-4 text-[10px] font-bold text-gray-400 uppercase">
