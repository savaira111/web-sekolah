        ...
        <div class="space-y-6 max-w-4xl">
            ...
            <div class="flex items-center gap-6">
                ...
                <h1 class="text-5xl lg:text-7xl font-black text-white leading-tight">
                    Pencak <span class="text-blue-500">Silat</span>
                </h1>
            </div>
                ...
                <div class="space-y-12">
                    <div class="space-y-6">
                        <div class="flex items-center gap-4">
                            ...
                            <h2 class="text-3xl font-black text-[#0F172A]">Tentang Pencak Silat</h2>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-2xl font-black text-[#0F172A] tracking-tight">40 Siswa</p>
                            </div>
                        </div>
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            <div class="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center text-blue-600">
                        ...
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-2xl font-black text-[#0F172A] tracking-tight">Sejak 2012</p>
                            </div>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="space-y-12">
                    ...
                    <div class="space-y-8">
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-lg font-bold text-[#0F172A]">Minat & Kedisiplinan</h4>
                                <p class="text-sm text-gray-500">Memiliki ketertarikan pada seni bela diri pencak silat dan siap mengikuti latihan fisik maupun mental dengan disiplin tinggi.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-lg font-bold text-[#0F172A]">Kesehatan & Ketahanan</h4>
                                <p class="text-sm text-gray-500">Lulus tes kesehatan dasar, tidak memiliki riwayat penyakit berat, dan memiliki ketahanan fisik yang memadai untuk berlatih gerakan silat.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                ...
                <div class="space-y-12">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                        <div class="aspect-square rounded-[1.5rem] overflow-hidden group cursor-pointer border border-gray-100 shadow-sm relative">
                            <img src="{{ asset('images/extracurriculars/thumbs/silat.png') }}" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110">
                        ...
                        <div class="aspect-square rounded-[1.5rem] overflow-hidden group cursor-pointer border border-gray-100 shadow-sm relative">
                            <img src="https://images.unsplash.com/photo-1555597673-b21d5c935865?q=80&w=800" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110">
                            <div class="absolute inset-0 bg-blue-600/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                            </div>
                        </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="group space-y-4">
                            <div class="aspect-[4/3] rounded-[2rem] overflow-hidden shadow-lg border border-gray-100">
                                <img src="{{ asset('images/extracurriculars/thumbs/silat.png') }}" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="space-y-2">
                                ...
                                <h3 class="text-lg font-bold text-[#0F172A] group-hover:text-blue-600 transition-colors leading-snug">Prestasi Gemilang Pencak Silat Tingkat Provinsi</h3>
                        ...
                        <div class="group space-y-4">
                            <div class="aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-lg border border-gray-100">
                                <img src="https://images.unsplash.com/photo-1555597673-b21d5c935865?q=80&w=800" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="space-y-2">
                                <div class="flex items-center gap-4 text-[10px] font-bold text-gray-400 uppercase">
