                 ...
                 <div class="space-y-12">
                    ...
                    <div class="space-y-8">
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-xl font-bold text-[#0F172A]">Minat & Kedisiplinan</h4>
                                <p class="text-gray-500">Memiliki ketertarikan pada seni bela diri pencak silat dan siap mengikuti latihan fisik maupun mental dengan disiplin tinggi.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-xl font-bold text-[#0F172A]">Kesehatan & Ketahanan</h4>
                                <p class="text-gray-500">Lulus tes kesehatan dasar, tidak memiliki riwayat penyakit berat, dan memiliki ketahanan fisik yang memadai untuk berlatih gerakan silat.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
