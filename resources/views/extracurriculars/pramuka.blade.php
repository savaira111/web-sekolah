        ...
        <div class="space-y-8 max-w-4xl">
            <div class="space-y-4">
                ...
                <h1 class="text-6xl lg:text-8xl font-black text-white leading-tight">
                    Praja Muda <br><span class="text-blue-500">Karana (Pramuka)</span>
                </h1>
                ...
                <div class="space-y-12">
                    <div class="space-y-6">
                        <div class="flex items-center gap-4">
                            ...
                            <h2 class="text-4xl font-black text-[#0F172A]">Tentang Pramuka</h2>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-3xl font-black text-[#0F172A] tracking-tight">Seluruh Siswa</p>
                            </div>
                        </div>
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            <div class="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center text-blue-600">
                 ...
                 <div class="space-y-12">
                    ...
                    <div class="space-y-8">
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-xl font-bold text-[#0F172A]">Kedisiplinan & Kemauan</h4>
                                <p class="text-gray-500">Memiliki kemauan belajar yang tinggi, disiplin, dan bersedia mengikuti seluruh kegiatan Pramuka dengan baik.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-xl font-bold text-[#0F172A]">Kesehatan & Jiwa Petualang</h4>
                                <p class="text-gray-500">Sehat secara jasmani dan bersedia mengikuti perkemahan serta berbagai kegiatan outdoor yang menguji ketangguhan.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="group space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <h3 class="text-xl font-bold text-[#0F172A] group-hover:text-blue-600 transition-colors leading-snug">Prestasi Gemilang Pramuka Tingkat Provinsi</h3>
