...
@section('title', 'Pramuka - SMKS Mahaputra')
...
<section class="relative min-h-screen flex items-start pt-16 lg:pt-20 overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img src="{{ asset('images/extracurriculars/thumbs/pramuka.png') }}" alt="Hero" class="w-full h-full object-cover">
        ...
        <div class="space-y-6 max-w-4xl">
            ...
            <div class="flex items-center gap-6">
                ...
                <h1 class="text-5xl lg:text-7xl font-black text-white leading-tight">
                    Praja Muda Karana <span class="text-blue-500">(Pramuka)</span>
                </h1>
            </div>
            <p class="text-xl text-gray-300 max-w-3xl leading-relaxed font-medium">
                Membangun karakter tangguh, mandiri, dan peduli lingkungan melalui kegiatan kepramukaan.
            </p>
        </div>
            ...
            <div class="flex flex-wrap gap-4 pt-10">
                ...
                <a href="https://wa.me/6282260337300?text=Halo%20Admin%2C%20saya%20ingin%20tanya%20seputar%20ekstrakurikuler%20Pramuka" target="_blank" class="px-10 py-5 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-2xl font-black text-xl hover:bg-white/20 transition-all uppercase flex items-center gap-3">
                ...
                <div class="space-y-12">
                    <div class="space-y-6">
                        <div class="flex items-center gap-4">
                            ...
                            <h2 class="text-3xl font-black text-[#0F172A]">Tentang Pramuka</h2>
                        </div>
                        <p class="text-base text-gray-500 leading-relaxed">
                            Pramuka SMKS Mahaputra Cerdas Utama merupakan wadah pembinaan generasi muda untuk mengembangkan potensi, bakat, dan semangat positif. Anggota dilatih untuk memiliki karakter unggul, kedisiplinan, dan etika yang baik serta berprestasi dalam berbagai kegiatan.
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-2xl font-black text-[#0F172A] tracking-tight">Seluruh Siswa</p>
                            </div>
                        </div>
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            <div class="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center text-blue-600">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-2xl font-black text-[#0F172A] tracking-tight">15+ Trophy</p>
                            </div>
                        </div>
                        <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-4 group transition-all duration-500">
                            <div class="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center text-blue-600">
                 ...
                 <div class="space-y-12">
                    ...
                    <div class="space-y-8">
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-lg font-bold text-[#0F172A]">Kedisiplinan & Kemauan</h4>
                                <p class="text-sm text-gray-500">Memiliki kemauan belajar yang tinggi, disiplin, dan bersedia mengikuti seluruh kegiatan Pramuka dengan baik.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-lg font-bold text-[#0F172A]">Kesehatan & Jiwa Petualang</h4>
                                <p class="text-sm text-gray-500">Sehat secara jasmani dan bersedia mengikuti perkemahan serta berbagai kegiatan outdoor yang menguji ketangguhan.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                <tr class="hover:bg-blue-50/30 transition-colors">
                                    <td class="px-8 py-6 font-bold text-[#0F172A]">Senin</td>
                                    <td class="px-8 py-6 text-gray-500">15:30 - 17:00</td>
                                    <td class="px-8 py-6 text-gray-500 font-bold">Materi Kepramukaan</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="space-y-12">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                        <div class="aspect-square rounded-[1.5rem] overflow-hidden group cursor-pointer border border-gray-100 shadow-sm relative">
                            <img src="{{ asset('images/extracurriculars/pramuka/pramuka_1.png') }}" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110">
                        ...
                        <div class="aspect-square rounded-[1.5rem] overflow-hidden group cursor-pointer border border-gray-100 shadow-sm relative">
                            <img src="{{ asset('images/extracurriculars/pramuka/pramuka_2.png') }}" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110">
                            <div class="absolute inset-0 bg-blue-600/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                            </div>
                        </div>
                        <div class="aspect-square rounded-[1.5rem] overflow-hidden group cursor-pointer border border-gray-100 shadow-sm relative">
                            <img src="{{ asset('images/extracurriculars/thumbs/pramuka.png') }}" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110">
                            <div class="absolute inset-0 bg-blue-600/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                            </div>
                        </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="group space-y-4">
                            <div class="aspect-[4/3] rounded-[2rem] overflow-hidden shadow-lg border border-gray-100">
                                <img src="{{ asset('images/extracurriculars/pramuka/pramuka_1.png') }}" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="space-y-2">
                                ...
                                <h3 class="text-lg font-bold text-[#0F172A] group-hover:text-blue-600 transition-colors leading-snug">Prestasi Gemilang Pramuka Tingkat Provinsi</h3>
                        ...
                        <div class="group space-y-4">
                            <div class="aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-lg border border-gray-100">
                                <img src="{{ asset('images/extracurriculars/pramuka/pramuka_2.png') }}" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="space-y-2">
                                <div class="flex items-center gap-4 text-[10px] font-bold text-gray-400 uppercase">
                                ...
                                <h3 class="text-xl font-bold text-[#0F172A] group-hover:text-blue-600 transition-colors leading-snug">Agenda Tahunan & Pelatihan Anggota Baru Pramuka</h3>
                                <div class="flex items-center gap-3 pt-2">
                                    <div class="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center">
                                        <svg class="w-4 h-4 text-blue-600" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08s5.97 1.09 6 3.08c-1.29 1.94-3.5 3.22-6 3.22z"/></svg>
                                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center gap-6 group">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Ketua Pramuka</p>
                            </div>
                        </div>
                    </div>
                </div>
