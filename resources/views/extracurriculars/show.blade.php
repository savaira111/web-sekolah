...
<section class="relative min-h-screen flex items-start pt-16 lg:pt-20 overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img src="{{ $mainImage }}" alt="{{ $eskul->name }}" class="w-full h-full object-cover">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div class="space-y-8 max-w-4xl">
            <div class="space-y-4">
                <span class="inline-block px-4 py-1.5 bg-blue-600 text-white text-[10px] font-bold rounded-lg uppercase tracking-wider">{{ $eskul->category ?? 'Ekstrakurikuler' }}</span>
            ...
            <div class="flex flex-wrap gap-4 pt-4">
                ...
                <a href="https://wa.me/6282260337300?text=Halo%20Admin%2C%20saya%20ingin%20tanya%20seputar%20ekstrakurikuler%20{{ $eskul->name }}" target="_blank" class="px-10 py-5 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-2xl font-black text-xl hover:bg-white/20 transition-all uppercase flex items-center gap-3">
                 ...
                 <div class="space-y-12">
                    ...
                    <div class="space-y-8">
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-xl font-bold text-[#0F172A]">Kriteria Utama</h4>
                                <p class="text-gray-500">Siswa/i SMKS Mahaputra Cerdas Utama yang memiliki minat dan bakat di bidang extracurricular ini.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-gray-500">Lulus tes kesehatan, tidak memiliki riwayat penyakit berat, serta memiliki stamina untuk latihan rutin.</p>
                            </div>
                        </div>
                        <div class="flex gap-8 group">
                        ...
                        <table class="w-full text-left">
                            <thead>
                                <tr class="bg-gray-50 border-b border-gray-100">
                                    ...
                                    <th class="px-8 py-6 text-sm font-black text-gray-400 uppercase tracking-widest">Keterangan</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-50">
                                ...
                                @if($schedule && is_array($schedule) && count($schedule) > 0)
                                    ...
                                    <tr class="hover:bg-blue-50/30 transition-colors">
                                        <td class="px-8 py-6 font-bold text-[#0F172A]">{{ $item['day'] ?? '-' }}</td>
                                        <td class="px-8 py-6 text-gray-500">{{ $item['start'] ?? '' }} - {{ $item['end'] ?? '' }}</td>
                                        <td class="px-8 py-6 text-gray-500 font-bold">Latihan Rutin</td>
                                    </tr>
                                    @endforeach
                                @else
                                    <tr class="hover:bg-blue-50/30 transition-colors">
                                        <td class="px-8 py-6 font-bold text-[#0F172A]">Menyusul</td>
                                        <td class="px-8 py-6 text-gray-500">{{ $eskul->schedule_info }}</td>
                                        <td class="px-8 py-6 text-gray-500 font-bold">-</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
                ...
                <div class="space-y-12">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                        ...
                        <div class="aspect-square rounded-[2.5rem] overflow-hidden group cursor-pointer border border-gray-100 shadow-sm relative">
                            <img src="{{ $img }}" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110">
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="group space-y-4">
                            <div class="aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-lg border border-gray-100">
                                <img src="{{ $galleryImages[0] ?? $mainImage }}" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="space-y-2">
                        ...
                        <div class="group space-y-4">
                            <div class="aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-lg border border-gray-100">
                                <img src="{{ $galleryImages[1] ?? $mainImage }}" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="space-y-2">
                                <div class="flex items-center gap-4 text-[10px] font-bold text-gray-400 uppercase">
            ...
            <div class="lg:col-span-4 space-y-8">
                ...
                <div class="bg-blue-600 rounded-[2.5rem] p-8 text-center space-y-8 shadow-2xl shadow-blue-500/20 relative overflow-hidden">
                    ...
                    <div class="relative z-10 space-y-4">
                        ...
                        <p class="text-sm text-blue-100">Jadilah bagian dari ekstrakurikuler unggulan sekolah. Pendaftaran sedang dibuka sekarang!</p>
                    </div>
                ...
                <div class="bg-white rounded-[2.5rem] border border-gray-100 p-8 space-y-6 shadow-sm">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center gap-6 group">
                            ...
                            <div class="space-y-1">
                                <p class="font-bold text-[#0F172A]">Pembina {{ $eskul->name }}</p>
                        ...
                        <div class="flex items-center gap-6 group">
                            ...
                            <div class="space-y-1">
                                <p class="font-bold text-[#0F172A]">Ketua Terpilih</p>
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Ketua Eskul</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-[2.5rem] border border-gray-100 p-8 space-y-6 shadow-sm">
                    ...
                    <div class="space-y-2 pt-2">
                        <p class="text-sm font-bold text-[#0F172A]">Area Sekolah</p>
