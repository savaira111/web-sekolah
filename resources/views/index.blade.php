        ...
        <div class="relative z-10 grid lg:grid-cols-2 gap-10 items-center">
            <div class="space-y-5">
                ...
                <div class="flex flex-wrap gap-3 pt-2">
                    <a href="{{ route('registration') }}" class="px-6 py-3 bg-blue-600 text-white rounded-xl font-bold text-sm hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-900 transition-all uppercase tracking-wide">Daftar Sekarang</a>
