        ...
        <div class="grid lg:grid-cols-2 gap-8 items-center reveal">
            <div class="space-y-3">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('enrollment.guide') }}" class="px-6 py-3.5 bg-blue-600 text-white rounded-xl font-bold text-base hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-200 transition-all">Daftar Sekarang</a>
                ...
                <div class="flex flex-wrap items-center gap-x-8 gap-y-4 pt-2">
                    ...
                    <div class="flex flex-col">
                        <span class="text-xl font-bold text-[#0F172A] counter" data-to="{{ preg_replace('/[^0-9.]/', '', $stat->value) }}" data-append="{{ preg_replace('/[0-9.]/', '', $stat->value) }}">{{ $stat->value }}</span>
            ...
            <div class="relative">
                ...
                <div class="relative z-10 bg-white p-3 rounded-[1.5rem] shadow-2xl overflow-hidden group">
                    <img src="{{ asset('images/logo-mahaputra.jpg') }}" alt="Logo SMKS Mahaputra Cerdas Utama" class="rounded-[1.5rem] w-full h-[350px] sm:h-[300px] object-contain transition-transform duration-1000 group-hover:scale-105 p-12">
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            ...
            <div class="p-6 rounded-3xl bg-white border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-200 text-center transition-all group duration-300 reveal reveal-scale">
                ...
                <h3 class="text-2xl font-bold text-[#0F172A] mb-2 counter" data-to="{{ preg_replace('/[^0-9.]/', '', $stat->value) }}" data-append="{{ preg_replace('/[0-9.]/', '', $stat->value) }}">{{ $stat->value }}</h3>
        ...
        <div class="grid lg:grid-cols-2 gap-8 items-center lg:gap-16">
            <div class="relative mx-auto max-w-[350px] lg:max-w-[420px] w-full reveal reveal-left">
                <div class="aspect-square rounded-[2rem] overflow-hidden shadow-2xl bg-white border-8 border-white p-2">
                    <img src="{{ asset('images/kepala-sekolah.png') }}" alt="Kepala Sekolah" class="w-full h-full object-contain rounded-[1.5rem]">
                </div>
...
<section class="py-8 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group bg-white rounded-[1.5rem] border border-gray-100 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col reveal" style="transition-delay: {{ $loop->index * 100 }}ms">
...
<section id="news" class="py-10 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            @endphp
            <div class="group bg-white rounded-[1.5rem] border border-gray-100 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 reveal" style="transition-delay: {{ $loop->index * 100 }}ms">
                <div class="aspect-video relative overflow-hidden">
                    ...
                    @else
                        <div class="w-full h-full {{ $style['bg'] }} flex flex-col items-center justify-center p-6">
        ...
        <div class="relative z-10 grid lg:grid-cols-2 gap-10 items-center">
            <div class="space-y-5">
                ...
                <div class="flex flex-wrap gap-3 pt-2">
                    ...
                    <a href="{{ route('contact') }}" class="px-6 py-3 bg-white/5 border border-white/10 text-white rounded-xl font-bold text-sm hover:bg-white/10 transition-all uppercase tracking-wide">Hubungi Kami</a>
                </div>
            </div>
