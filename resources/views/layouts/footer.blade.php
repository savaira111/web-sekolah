    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <div class="space-y-6">
                <a href="{{ route('home') }}" class="flex items-center gap-2">
                    <img src="{{ asset('images/logo-mahaputra.jpg') }}" alt="Logo" class="h-12 w-auto">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="{{ route('jurusan.dkv') }}" class="text-gray-500 hover:text-blue-600 transition-colors">DKV (Desain Komunikasi Visual)</a></li>
                    <li><a href="{{ route('jurusan.pplg') }}" class="text-gray-500 hover:text-blue-600 transition-colors">PPLG (Pengembangan Perangkat Lunak)</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-gray-400 text-sm">
                &copy; {{ date('Y') }} SMKS MAHAPUTRA CERDAS UTAMA. All Rights Reserved.
            </p>
