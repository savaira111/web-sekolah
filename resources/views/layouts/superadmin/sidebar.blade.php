<aside class="w-64 sidebar h-full flex flex-col transition-all duration-300 z-20 shrink-0 border-r border-gray-800" :class="{'hidden': !sidebarOpen}">
    ...
    <div class="flex-1 overflow-y-auto py-6 px-4 space-y-1">
        ...
        class="flex items-center gap-3 px-4 py-3 rounded-full font-medium text-sm transition-colors
        {{ request()->routeIs('superadmin.landing-stats.*') ? 'sidebar-active shadow-lg shadow-blue-500/20' : 'sidebar-item' }}">

            <svg class="w-5 h-5 {{ request()->routeIs('superadmin.landing-stats.*') ? 'text-white' : '' }}"
            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
        ...
        class="flex items-center gap-3 px-4 py-3 rounded-full font-medium text-sm transition-colors
        {{ request()->routeIs('superadmin.partners.*') ? 'sidebar-active shadow-lg shadow-blue-500/20' : 'sidebar-item' }}">

            <svg class="w-5 h-5 {{ request()->routeIs('superadmin.partners.*') ? 'text-white' : '' }}"
            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
