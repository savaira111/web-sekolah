    ...
    <div class="flex items-center gap-4">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
            <h2 class="text-lg md:text-xl font-black tracking-tight leading-none" 
                ...
                @yield('navbar_title', 'Dashboard Overview')
            </h2>
                ...
                <a href="{{ $notification['link'] }}" class="block px-4 py-3 border-b last:border-0 hover:bg-gray-50 dark:hover:bg-gray-800/50 cursor-pointer transition-colors duration-300" 
                    ...
                    <div class="flex gap-3">
                        <div class="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 
                            @if($notification['type'] === 'ppdb') bg-blue-50 text-blue-500 
                            @elseif($notification['type'] === 'eskul') bg-purple-50 text-purple-500 
                            @elseif($notification['type'] === 'message') bg-amber-50 text-amber-500 
