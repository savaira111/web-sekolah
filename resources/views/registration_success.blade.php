...
@section('content')
<section class="min-h-screen bg-[#0F172A]/90 flex items-center justify-center p-4">
    <div class="max-w-md w-full bg-white rounded-[3rem] p-10 shadow-2xl space-y-8 text-center relative overflow-hidden">
        <!-- Close/Home Button -->
        ...
        <div class="relative z-10">
            <div class="w-24 h-24 bg-green-500 rounded-full flex items-center justify-center mx-auto shadow-xl shadow-green-200">
        ...
        <div class="space-y-3 relative z-10">
            ...
            <div class="bg-blue-50 py-3 rounded-2xl">
                <span class="text-xl font-black text-blue-600 tracking-wider">REG-2025001</span>
            </div>
        </div>
