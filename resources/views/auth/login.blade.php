...
<head>
    ...
    <title>Login - SMKS Mahaputra Cerdas Utama</title>
...
<body class="antialiased min-h-screen flex items-center justify-center p-4 login-bg" x-data="loginForm">
    ...
    <div class="max-w-[1000px] w-full bg-white rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] overflow-hidden flex flex-col md:flex-row min-h-[600px]">
        ...
        <div class="md:w-1/2 relative hidden md:block group">
            <img src="{{ asset('images/gedung-sekolah.jpg') }}" alt="Gedung Sekolah" class="w-full h-full object-cover">
            ...
            <div class="absolute bottom-10 left-10 right-10 z-10 space-y-4">
                <div class="flex items-center gap-3">
                    ...
                    <h2 class="text-white text-2xl font-bold tracking-tight">SMKS Mahaputra</h2>
                </div>
        ...
        <div class="md:w-1/2 p-10 lg:p-14 flex flex-col justify-center relative bg-white">
            <div class="max-w-md w-full mx-auto space-y-8">
                ...
                <!-- Header -->
                <div class="space-y-2">
                    <h1 class="text-3xl font-bold text-[#0F172A] tracking-tight">Login Akun Mahaputra</h1>
                ...
                <form action="{{ route('login.post') }}" method="POST" class="space-y-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="login" name="login" class="block w-full pl-11 pr-4 py-3 border border-gray-200 rounded-xl text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors bg-gray-50/50" placeholder="Masukkan Username atau Email" value="{{ old('login') }}" required>
                        </div>
                        @error('login')
                ...
                <div class="text-center pt-4">
                    <a href="{{ route('home') }}" class="inline-flex items-center text-xs font-bold text-gray-400 hover:text-gray-700 transition-colors">
